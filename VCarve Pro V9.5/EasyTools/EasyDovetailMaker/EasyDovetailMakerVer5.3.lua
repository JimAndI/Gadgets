...
-- ===================================================]]
function DovetailPinPocketsRight(xpt1)                  -- Front Borad Righthand
...
-- ===================================================]]
function DovetailPinPocketsLeft(xpt1)                   -- Front Borad Lefthand
...
function main(script_path)                              -- Main Function (script_path)
  ...
  Dovetail.RegBitName = "EasyDovetailToolDatabase2.0"
...
function BitHeaderReader()
  ...
  while(RegistryRead:StringExists("Bit" .. tostring(Dovetail.HeaderCount + 1 .. "-BitName"))) do
    table.insert(Tools, RegistryRead:GetString("Bit" .. tostring(Dovetail.HeaderCount + 1) .. "-BitName", "Error: No Bits Found in Registry"))
