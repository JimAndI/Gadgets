...
function CutListfileWriter(datFile)
    ...
    -- write line of the file
        ...
        if g_shelfCount >= 1 then
            file:write("Shelf Panle           - ".. g_shelfCount .." pcs of ".. g_materialThickness .." Plywood ".. g_shelfDepth  .." X ".. g_shelfLength .." \n")
        end
        ...
        if g_faceFrameCenter2 == "Y" then
            file:write("Center Panle           - 1 pcs of ".. g_materialThickness .." Plywood ".. (g_boxDepth + (g_materialThicknessBack * 0.5))  .." X ".. g_boxHight - g_materialThickness .."     \n")
        end
