...
-- ==============================================================================
function BottomCabinetBottom(side, lay)
    local job = VectricJob()
    if not job.Exists then
        DisplayMessageBox("No job loaded")
        return false;
...
function LoadDialog(job, script_path)
	MessageBox(
    "g_pinShelfClarence = " ..   tostring(g_pinShelfClarence)
    )
    
    MessageBox(
    "g_materialThicknessBack = " ..    tostring(g_materialThicknessBack)
    )
    ...
    dialog:AddDoubleField("g_millingTool",                      g_millingTool)    
    dialog:AddDoubleField("g_toolSizeDia",                      g_toolSizeDia)
    ...
    dialog:AddTextField("g_drawingUnits",                       g_drawingUnits)
    ...
    g_toolSizeDia =             tonumber(dialog:GetDoubleField("g_toolSizeDia"))
    ...
    g_drawingUnits =            dialog:GetTextField("g_drawingUnits")
    g_defaultToolName =         dialog:GetTextField("g_defaultToolName")
