...
Boxjoint Toolpaths program is very heavily based on code from Vectric's core 
software SDK, Brian Moran and many other great developers.
]]
...
function CreateBoxjointToolpath(job, layer_name, toolpath_name)
  ...
  local toolpath = toolpath_manager:CreatePocketingToolpath(toolpath_name, g_tool, area_clear_tool, pocket_data, pos_data, geometry_selector, create_2d_previews, true)
