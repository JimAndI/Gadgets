...
---------------------------------------------------------------------------------------------------------------------------------
		...
		TeethA[table.getn(TeethA)+1] = DrawArC(job, Point2D(Teeth[1].StartPoint2D.x, Teeth[1].StartPoint2D.y), Point2D(Teeth[table.getn(Teeth)].EndPoint2D.x,Teeth[table.getn(Teeth)].EndPoint2D.y),Point2D(origin_off.x,origin_off.y), "Tooth")
		test = TeethA[table.getn(TeethA)]:Reverse ()
		--Refresh (job,TeethA[table.getn(TeethA)],"Tooth")
		
		for i=1,table.getn(Teeth) do
