...
-- create a Toolpath to round a blank
    ...
    local SquareStockDimension = 5.20
    local StockStartDimension = 0.0000
    local Stock = 0.0000
    local StockEndDimension = 21.5000
    local BitDiameter = 1.25000
    local FeedRate = 75.000
    local SpindleSpeed = 20000 
    local BitCutDepth = 0.1000
    local BitStepOverMax = 0.990    -- Add this function
    local BitStepOver = 0.200
    local FinishedDiameter = 5.0000
    local FinishedRadus = FinishedDiameter * 0.5
    local StepOver = BitDiameter * BitStepOver
    local RowCount = 200
    -- =============================================================
...
--	file:write("N180 A0.0000 X0.0000 Z" .. SquairToRoundRadusClear .. " F" .. FeedRate .." \n")
	file:write("N180 G00 Z" .. SquairToRoundRadusClear .. "  \n")
    file:write("N190 G00 X0.0000 A0.0000  \n")   
	...
	for i = 1, end_index do
        ...
        -- Ring the end
            file:write("N" .. RowCount .. " G01 Z" .. CutRadus .. " A" .. (RevolutionAngle1 - 45) .. " F" .. (FeedRate * 0.75) .." \n")
	...
	file:write("% \n")
       DisplayMessageBox("File Complete: " .. filename )
    return true 
end  -- function end
-- ===================================================