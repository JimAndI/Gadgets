...
function REG_LoadRegistry() -- Write to Registry values
    ...
    local RegValue = RegistryWrite:SetString("Milling.LayerNameFrontBroad", "Pin Broad")
    RegValue = RegistryWrite:SetString("Milling.LayerNameSideBroad", "Tail Broad")
    RegValue = RegistryWrite:SetString("Milling.LayerNameDovetailPath", "Pin Dovetail Path")
    RegValue = RegistryWrite:SetString("Milling.LayerNameClearing", "Pin Dovetail Clearing")    
    RegValue = RegistryWrite:SetString("Milling.LayerNameSidePocket", "Tail Pockets")   
...
function REG_ReadRegistry()  -- Read from Registry values
    ...
    Milling.LayerNameFrontBroad = RegistryRead:GetString("Milling.LayerNameFrontBroad", "Pin Broad")    
    Milling.LayerNameSideBroad = RegistryRead:GetString("Milling.LayerNameSideBroad", "Tail Broad")  
    Milling.LayerNameSidePocket = RegistryRead:GetString("Milling.LayerNameSidePocket", "Tail Pockets")      
    Milling.LayerNameDovetailPath = RegistryRead:GetString("Milling.LayerNameDovetailPath", "Pin Dovetail Path")      
    Milling.LayerNameClearing = RegistryRead:GetString("Milling.LayerNameClearing", "Pin Dovetail Clearing")      
