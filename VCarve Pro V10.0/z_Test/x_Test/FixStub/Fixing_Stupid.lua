...
--[[
Fixing Stupid by Vectric Program User in Louisiana. (May 2019)
]]

g_version = "1.0"
g_title   = "Fixing Stupid Gadget"
...
function main(script_path)
    ...
    local script_html = "file:" .. script_path .. "\\Fixing_Stupid.htm"
    local dialog = HTML_Dialog(false, script_html, 640, 450, g_title)
