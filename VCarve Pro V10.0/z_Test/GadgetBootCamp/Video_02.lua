...
function  DrawCircle(job, Pt1, CenterRadius, Layer)
  ...
  -- Pt1 - (2Dpoint) center of the circle
  -- CenterRadius - radius of the circle
...
-- ===================================================]]
function DrawLine(job, Pt1, Pt2, Layer)
...
-- Do Something --
  ...
  DrawCircle(job, Wpt0, 0.5, Layer) -- draw circles
  DrawCircle(job, Wpt1, 0.5, Layer)
  DrawCircle(job, Wpt2, 0.5, Layer)
  DrawCircle(job, Wpt3, 0.5, Layer)
