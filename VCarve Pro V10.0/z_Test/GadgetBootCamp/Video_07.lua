...
Stair.Version     = "7.0"                              --* Application Build Version
...
function DrawStringer(job)                              -- Draws a Open string   
  ...
  if Stair.DrawWorkPoints then     --* Controls if the work point is shown
    ...
    DrawCircle(job,  Wpt0, 0.125, "WP: Circle String")
    
    MarkAPoint(job, "Wpt1", Wpt1, 3, "WP: Note String")  
    DrawCircle(job,  Wpt1, 0.125, "WP: Circle String")
    
    MarkAPoint(job, "Wpt2", Wpt2, 3, "WP: Note String")  
    DrawCircle(job,  Wpt2, 0.125, "WP: Circle String")
    
    MarkAPoint(job, "Wp2" , Wp2,  3, "WP: Note String")  
    DrawCircle(job,  Wp2, 0.125, "WP: Circle String")
    
    MarkAPoint(job, "Wp3" , Wp3,  3, "WP: Note String")  
    DrawCircle(job,  Wp3, 0.125, "WP: Circle String")
    
    MarkAPoint(job, "Wp4" , Wp4,  3, "WP: Note String")  
    DrawCircle(job,  Wp4, 0.125, "WP: Circle String")
    
    MarkAPoint(job, "Wp5" , Wp5,  3, "WP: Note String")  
    DrawCircle(job,  Wp5, 0.125, "WP: Circle String")
    
    MarkAPoint(job, "Wp6" , Wp6,  3, "WP: Note String")  
    DrawCircle(job,  Wp6, 0.125, "WP: Circle String")

    MarkAPoint(job, "Wp7" , Wp7,  3, "WP: Note String")  
    DrawCircle(job,  Wp7, 0.125, "WP: Circle String")
  end
    ...
    for i = Stair.StepCount, 1, -1  do
      if Stair.DrawWorkPoints then  --* Controls if the work point is shown
        ...
        DrawCircle(job,  Wpy, 0.125, "WP: Circle Stringer")
        
        MarkAPoint(job, "Wpz" .. "-" .. tostring(i), Wpz, 3, "WP: Note Stringer")  
        DrawCircle(job,  Wpz, 0.125, "WP: Circle Stringer")
      end  --if end
      line:LineTo(Wpy)         
      line:LineTo(Wpz)         
      Wpx = Wpz
...
function OnLuaButton_ButtonCalulate(dialog)             --* Executes the calculation function from the dialogue
  ...
  Stair.StepRun = Stair.RunDim / Stair.StepCount          -- calculate the stair run (horizontal) dimension
  Stair.StepRise = Stair.RiseDim / (Stair.StepCount + 1)  -- calculate the stair rise (vertical) dimension
...
function InquiryBox(Header)                             --* Displays a dialog box for user inputs
    ...
    .LuaButton {	font-weight: bold;	width: 75px;	font-family: Arial, Helvetica, sans-serif;	font-size: 12px;}
...
<table width="480" border="0">
  ...
  <tr>
    ...
    <td width="50" align="center" nowrap="nowrap" class="h1-c">&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="2" nowrap="nowrap"><input name = "Stair.TreadLayer" type = "text" id = "Stair.TreadLayer" size = "25" maxlength="25" /></td>
    <td width="102" align="center" nowrap="nowrap" class="h1-r">&nbsp;</td>
    <td width="102" nowrap="nowrap">&nbsp;</td>
  </tr>
  <tr>
    <td width="102" align="right" nowrap="nowrap" class="h1-r">Riser Layer:</td>
    <td colspan="2" nowrap="nowrap"><input name = "Stair.RiserLayer" type = "text" id = "Stair.RiserLayer" size = "25" maxlength="25" /></td>
    <td width="102" align="center" nowrap="nowrap" class="h1-r">&nbsp;</td>
    <td width="102" nowrap="nowrap">&nbsp;</td>
  </tr>
  <tr>
    <td width="102" align="right" nowrap="nowrap" class="h1-r">Stringer Layer:</td>
    <td colspan="2" nowrap="nowrap"><input name = "Stair.StringerLayer" type = "text" id = "Stair.StringerLayer" size = "25" maxlength="25" /></td>
    <td width="102" align="center" nowrap="nowrap" class="h1-r">&nbsp;</td>
    <td width="102" nowrap="nowrap">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="50" nowrap="nowrap"><input type="checkbox" name="Stair.DrawWorkPoints" id="Stair.DrawWorkPoints"></td>
...
-- Get Data --
  ...
  InquiryBox(Stair.AppName .. " Version " .. Stair.Version)
