...
--[[  -- Remove from Scope (Video 6)
-- The ReadRegistry() and WriteRegistry() store and recall the user imputs/default values in the registry
  ...
  Stair.DrawWorkPoints = false    -- true = Turns on and false turns off all workpoints 
]]

Stair.AppName     = "Easy Stair Maker"                 --* Application Name
Stair.Version     = "6.0"                              --* Application Build Version
...
function ReadRegistry()                                 --* Reads data from the Registry
  ...
  Stair.StepCount        = RegistryRead:GetInt("Stair.CabCount", 6)     -- number of steps  
