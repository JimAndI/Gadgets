...
function InquiryDovetail(Header)
    ...
    local dialog = HTML_Dialog(true, myHtml, 475, 220,  Header) ;
...
function DovetailPockets(pt1)
    ...
    local pt03  = Polar2D(pt2,  270.0,   Milling.DovetailToolRadius)
          pt01  = Polar2D(pt01, (360.0 - Milling.DovetailToolAngle),   Milling.StrightToolDia)
          pt04  = Polar2D(pt04, Milling.DovetailToolAngle,             Milling.StrightToolDia)
          pt02  = Polar2D(pt02, (180.0 - Milling.DovetailToolAngle),   Milling.StrightToolDia)
          pt03  = Polar2D(pt03, (180.0 + Milling.DovetailToolAngle),   Milling.StrightToolDia)
