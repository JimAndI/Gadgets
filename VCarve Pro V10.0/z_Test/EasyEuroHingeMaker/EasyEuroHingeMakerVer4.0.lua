...
Hinge.Tool_ID1 = ToolDBId()
Hinge.Tool_ID2 = ToolDBId()
Hinge.Tool_ID3 = ToolDBId()
Hinge.Tool_ID4 = ToolDBId()
...
Hinge.Tool_ID1:LoadDefaults("My Profile1",   "")
Hinge.Tool_ID2:LoadDefaults("My Pocket2",    "")
Hinge.Tool_ID3:LoadDefaults("My Clearing3",  "")
Hinge.Tool_ID4:LoadDefaults("My DrillPath4", "")
-- ===================================================]]
...
function DrawHingeHole(pt, ang)
  local phcp   = Polar2D(pt,   ang  + 180.0,  Hinge.HingeCupSetBack + Hinge.HingeCupRadius)
  local pt1    = Polar2D(phcp,   0.0,  Hinge.HingeCupRadius)
  local pt2    = Polar2D(phcp, 180.0,  Hinge.HingeCupRadius)
  local phsp   = Polar2D(phcp, ang + 180.0, Hinge.HingeCupSetBack + Hinge.HingeCupRadius)
