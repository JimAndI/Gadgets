...
function main(script_path)
	...
	--> We'll start of with some default values, first the imperial values
		...
		local BottomStyle = 4	--> How to draw bottom of box
	...
	myHTML:AddRadioGroup("BottomStyle",4)
	myHTML:AddRadioGroup("LidStyle",2)
...
--> Close to done. If they included bottom rails lets build a simple vector they can use to cut out a bottom piece
		...
		local Script_Path = myHTML:GetLabelField("Script_Path")
		local html_path = "file:" .. Script_Path .. "\\Box_Joints_Reminder.htm"
		myHTML = HTML_Dialog(false, html_path, 750, 800, "Box Joints is complete")
		myHTML:AddLabelField("LayerName", LayerName.." FB")
		myHTML:AddLabelField("LayerNameEnd", LayerName.." End")
		myHTML:AddLabelField("LayerNameLid", LayerName.." Lid")
		myHTML:AddLabelField("LayerNameBottom", LayerName.." Bottom")
		myHTML:ShowDialog()
	end
	return
end
