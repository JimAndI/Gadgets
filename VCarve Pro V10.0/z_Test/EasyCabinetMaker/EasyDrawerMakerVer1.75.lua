...
--[[
    ...
    if not(Drawer.FrontThickness == Drawer.BackThickness) then
      ...
      -- ==== Sheet 4
    if not(Drawer.BottomThickness == Drawer.BackThickness) then
      NewSheet()
      g_pt5 = Point2D(1, 1)
    end
]]
...
function ProcessFront()
  ...
  -- Drawer.WP = Polar2D(Drawer.WP, 180.0, Milling.PartGap)                        --  Front Panel
...
function ProcessBack()
  ...
  -- Drawer.WP = Polar2D(Drawer.WP, 180.0, Milling.PartGap)                         -- Back Panel
...
function ProcessBottom()
  ...
  -- Drawer.WP = Polar2D(Drawer.WP, 180.0, Milling.PartGap)                               -- Draw Panel Bottom
