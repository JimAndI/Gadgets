...
local layer
local BaseSDK = "https://jimandi.com/SDKWiki/index.php?title=Easy_Cabinet_Maker-Page8"
local LayerSDK = "https://jimandi.com/SDKWiki/index.php?title=Easy_Cabinet_Maker-Page7"
local ProjectSDK = "https://jimandi.com/SDKWiki/index.php?title=Easy_Cabinet_Maker-Page10"
local MillingSDK = "https://jimandi.com/SDKWiki/index.php?title=Easy_Cabinet_Maker-Page9"
local MainSDK = "https://jimandi.com/SDKWiki/index.php?title=Easy_Cabinet_Maker-Page12"
local WallSDK = "https://jimandi.com/SDKWiki/index.php?title=Easy_Cabinet_Maker-Page11"
...
function InquiryWallOrBase(Header, Quest, DList)
  local dialog = HTML_Dialog(true, DialogWindow.myHtml7, 500, 488,  Header .. "  " .. Milling.UnitDisplay)
...
function OnLuaButton_InquiryMilling()
  local dialog = HTML_Dialog(true, DialogWindow.myHtml3 , 498, 216, "Milling Setting ")
...
function OnLuaButton_InquiryWallQuestion()
  local dialog = HTML_Dialog(true,  DialogWindow.myHtml1, 619, 424, "Wall Cabinet Setup")
