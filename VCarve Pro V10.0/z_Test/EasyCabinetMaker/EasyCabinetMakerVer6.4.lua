...
function Wall_Math()  --  All the math for Wall Cabinet
  ...
  ProjectQuestion.DrawerID = StartDate()
...
function REG_ReadRegistry()  --  Read from Registry values
  ...
  ProjectQuestion.CabinetName = RegistryRead:GetString("ProjectQuestion.CabinetName", "Default")
  ProjectQuestion.ProgramCodeBy = RegistryRead:GetString("ProjectQuestion.ProgramCodeBy", "James Anderson")
  ProjectQuestion.ProgramName = RegistryRead:GetString("ProjectQuestion.ProgramName", "Easy Cabinet Maker")
  ProjectQuestion.ProgramVersion = RegistryRead:GetString("ProjectQuestion.ProgramVersion", VerNumber)
  ProjectQuestion.ProgramYear = RegistryRead:GetString("ProjectQuestion.ProgramYear", YearNumber)
  ProjectQuestion.ProjectContactEmail = RegistryRead:GetString("ProjectQuestion.ProjectContactEmail", "Default@Email.com")
  ProjectQuestion.ProjectContactName = RegistryRead:GetString("ProjectQuestion.ProjectContactName", "Who")
  ProjectQuestion.ProjectContactPhoneNumber = RegistryRead:GetString("ProjectQuestion.ProjectContactPhoneNumber", "(123)456-7890")
  ProjectQuestion.ProjectName = RegistryRead:GetString("ProjectQuestion.ProjectName", "CABINET PROJECTS")
  ProjectQuestion.ProjectPath = RegistryRead:GetString("ProjectQuestion.ProjectPath", "Default")
...
--  WallDim.StretcherThickness = RegistryRead:GetDouble("WallDim.StretcherThickness", 0.7500)
--  WallDim.StretcherWidth = RegistryRead:GetDouble("WallDim.StretcherWidth", 3.500)
  ...
  DialogWindow.InquiryWallOrBaseXX0 = RegistryRead:GetString("DialogWindow.InquiryWallOrBaseXX0", "0")
  DialogWindow.InquiryWallOrBaseYY0 = RegistryRead:GetString("DialogWindow.InquiryWallOrBaseYY0", "0")
  DialogWindow.ProjectSetupXX0      = RegistryRead:GetString("DialogWindow.ProjectSetupXX0", "0")
  DialogWindow.ProjectSetupYY0      = RegistryRead:GetString("DialogWindow.ProjectSetupYY0", "0")
  DialogWindow.LayerSetupXX0        = RegistryRead:GetString("DialogWindow.LayerSetupXX0", "0")
  DialogWindow.LayerSetupYY0        = RegistryRead:GetString("DialogWindow.LayerSetupYY0", "0")
  DialogWindow.AboutXX0             = RegistryRead:GetString("DialogWindow.AboutXX0", "0")
  DialogWindow.AboutYY0             = RegistryRead:GetString("DialogWindow.AboutYY0", "0")
  DialogWindow.MillingSettingXX0    = RegistryRead:GetString("DialogWindow.MillingSettingXX0", "0")
  DialogWindow.MillingSettingYY0    = RegistryRead:GetString("DialogWindow.MillingSettingYY0", "0")
  DialogWindow.WallCabinetSetupXX0  = RegistryRead:GetString("DialogWindow.WallCabinetSetupXX0", "0")
  DialogWindow.WallCabinetSetupYY0  = RegistryRead:GetString("DialogWindow.WallCabinetSetupYY0", "0")
  DialogWindow.BaseCabinetSetupXX0  = RegistryRead:GetString("DialogWindow.BaseCabinetSetupXX0", "0")
  DialogWindow.BaseCabinetSetupYY0  = RegistryRead:GetString("DialogWindow.BaseCabinetSetupYY0", "0")
  return true
end
-- ===================================================]]
...
local RegValue = RW:SetDouble("BaseDim.CabDepth" ,  BaseDim.CabDepth)
...
-- RegValue = RW:SetDouble("WallDim.StretcherThickness" , WallDim.StretcherThickness)
-- RegValue = RW:SetDouble("WallDim.StretcherWidth" , WallDim.StretcherWidth)
...
RegValue = RW:SetString("ProjectQuestion.CabinetName" , ProjectQuestion.CabinetName)
RegValue = RW:SetString("ProjectQuestion.Drawing" , ProjectQuestion.Drawing )
RegValue = RW:SetString("ProjectQuestion.ProgramCodeBy" , ProjectQuestion.ProgramCodeBy)
RegValue = RW:SetString("ProjectQuestion.ProgramName" , ProjectQuestion.ProgramName)
RegValue = RW:SetString("ProjectQuestion.ProgramVersion" , ProjectQuestion.ProgramVersion)
RegValue = RW:SetString("ProjectQuestion.ProgramYear" , ProjectQuestion.ProgramYear)
RegValue = RW:SetString("ProjectQuestion.ProjectContactEmail" , ProjectQuestion.ProjectContactEmail)
RegValue = RW:SetString("ProjectQuestion.ProjectContactName" , ProjectQuestion.ProjectContactName)
RegValue = RW:SetString("ProjectQuestion.ProjectContactPhoneNumber" , ProjectQuestion.ProjectContactPhoneNumber)
RegValue = RW:SetString("ProjectQuestion.ProjectName" , ProjectQuestion.ProjectName)
RegValue = RW:SetString("ProjectQuestion.ProjectName" , string.upper(ProjectQuestion.ProjectName))
RegValue = RW:SetString("ProjectQuestion.ProjectPath" , ProjectQuestion.ProjectPath)
...
RegValue = RW:SetString("DialogWindow.InquiryWallOrBaseXX0" , DialogWindow.InquiryWallOrBaseXX0)
RegValue = RW:SetString("DialogWindow.InquiryWallOrBaseYY0" , DialogWindow.InquiryWallOrBaseYY0)
RegValue = RW:SetString("DialogWindow.ProjectSetupXX0" , DialogWindow.ProjectSetupXX0)
RegValue = RW:SetString("DialogWindow.ProjectSetupYY0" , DialogWindow.ProjectSetupYY0)
RegValue = RW:SetString("DialogWindow.LayerSetupXX0" , DialogWindow.LayerSetupXX0)
RegValue = RW:SetString("DialogWindow.LayerSetupYY0" , DialogWindow.LayerSetupYY0)
RegValue = RW:SetString("DialogWindow.AboutXX0" , DialogWindow.AboutXX0)
RegValue = RW:SetString("DialogWindow.AboutYY0" , DialogWindow.AboutYY0)
RegValue = RW:SetString("DialogWindow.MillingSettingXX0" , DialogWindow.MillingSettingXX0)
RegValue = RW:SetString("DialogWindow.MillingSettingYY0" , DialogWindow.MillingSettingYY0)
RegValue = RW:SetString("DialogWindow.WallCabinetSetupXX0" , DialogWindow.WallCabinetSetupXX0)
RegValue = RW:SetString("DialogWindow.WallCabinetSetupYY0" , DialogWindow.WallCabinetSetupYY0)
RegValue = RW:SetString("DialogWindow.BaseCabinetSetupXX0" , DialogWindow.BaseCabinetSetupXX0)
RegValue = RW:SetString("DialogWindow.BaseCabinetSetupYY0" , DialogWindow.BaseCabinetSetupYY0)
end
--  ===================================================]]
...
function InquiryWallOrBase(Header, Quest, DList)
  ...
  dialog:AddTextField("ProjectQuestion.CabinetName", ProjectQuestion.CabinetName)
  ...
  if  dialog:ShowDialog() then
    ...
    ProjectQuestion.CabinetName = dialog:GetTextField("ProjectQuestion.CabinetName")
    ProjectQuestion.NewSheet = string.upper(dialog:GetDropDownListValue("ProjectQuestion.NewSheet"))
    ...
    DialogWindow.InquiryWallOrBaseXX0 = tostring(dialog.WindowWidth)
    DialogWindow.InquiryWallOrBaseYY0 = tostring(dialog.WindowHeight)
    REG_UpdateRegistry()
...
local myHtml = [[<html><head><title>Project Setup</title><style type="text/css">html{overflow:hidden} .helpbutton { background-color:#E1E1E1; border:1px solid #999; 	border-right-color:#000; border-bottom-color:#000; border-top-color:#FFF; border-left-color:#FFF; padding:2px 12px; font-family:Arial, Helvetica, sans-serif; text-align:center; text-decoration:none; font-size:12px; margin:4px 2px; color:#000 } .helpbutton:active { border-right-color:#FFF;	border-bottom-color:#FFF; border-top-color:#000; border-left-color:#000} .helpbutton:hover {	border-right-color:#000;	border-bottom-color:#000;	border-top-color:#FFF;	border-left-color:#FFF} .LuaButton{font-weight:bold;font-family:Arial,Helvetica,sans-serif;font-size:12px;vertical-align:middle} .DirectoryPicker{font-weight:bold;font-family:Arial,Helvetica,sans-serif;font-size:12px} .ToolPicker{font-weight:bold;text-align:center;font-family:Arial,Helvetica,sans-serif;font-size:12px} .ToolNameLabel{font-family:Arial,Helvetica,sans-serif;font-weight:bolder;font-size:12px;text-align:left;color:#FF0} .FormButton{font-weight:bold;width:75px;font-family:Arial,Helvetica,sans-serif;font-size:12px;white-space:nowrap} .h1-l{font-family:Arial,Helvetica,sans-serif;font-size:12px;text-align:left;white-space:nowrap} .h1-r{font-family:Arial,Helvetica,sans-serif;font-size:12px;text-align:right;white-space:nowrap} .alert{font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;color:#00F;text-align:center;white-space:nowrap} .h1-c{font-family:Arial,Helvetica,sans-serif;font-size:12px;text-align:center;white-space:nowrap}body{background-color:#CCC;overflow:hidden;font-family:Arial,Helvetica,sans-serif;font-size:12px}</style></head><body bgcolor = "#EBEBEB" text = "#000000"><table width="493" border="0" cellpadding="0" id="ValuesTable"><tr><td width="182" align="right" valign="middle" nowrap class="h1-r">Project Name</td><td colspan="2" align="right" valign="middle" nowrap class="h1-l"><input name = "ProjectQuestion.ProjectName" type="text" class="h2" id="ProjectQuestion.ProjectName" size="50" maxlength="50" /></td></tr><tr><td align="right" valign = "middle" nowrap class="h1-r">Project Contact Name</td><td colspan="2" align="right" valign="middle" nowrap class="h1-l"><input name= "ProjectQuestion.ProjectContactName" type="text" class="h2" id="ProjectQuestion.ProjectContactName" size="50" maxlength="50" /></td></tr><tr><td align="right" valign="middle" nowrap class="h1-r">Project Contact Email</td><td colspan="2" align="right" valign="middle" nowrap class="h1-l"><input colspan="4" name="ProjectQuestion.ProjectContactEmail" type="text" class="h2" id="ProjectQuestion.ProjectContactEmail" size="50" maxlength="50" /></td></tr><tr><td align="right" valign="middle" nowrap class="h1-r">Project Contact Phone Number</td><td colspan="2" align="right" valign="middle" nowrap class="h1-l"><input name="ProjectQuestion.ProjectContactPhoneNumber" type= "text" class="h2" id= "ProjectQuestion.ProjectContactPhoneNumber" size="50" maxlength="50" /></td></tr><tr><td align ="right" valign="middle" nowrap class="h1-r">Project Start Date</td><td width="183" align="right" valign="middle" nowrap class ="h1-l"><input name ="ProjectQuestion.DrawerID" type="text" class="h2" id="ProjectQuestion.DrawerID" size="16" maxlength="16" readonly /></td><td width="120" align="right" valign="middle" nowrap class="h1-l"></td></tr></table><table width="493" border="0" id="PathTable"><tr><td width="159" height="10"><span class="h1-r"><span class="h1-r">Project Path </span></span></td><td width="258"><span class="h1"> <input name="ProjectQuestion.ProjectPath" type="text" class="h2" id="ProjectQuestion.ProjectPath" size="58" maxlength="250" /> </span></td><td width="90" align="center"><span class="h1"> <input id = "DirectoryPicker" class = "DirectoryPicker" name = "DirectoryPicker" type = "button" value = "Path..."> </span></td></tr></table><table width="520" border="0" id="ButtonTable"><tr><td height="12" colspan="3" align="right" valign="middle" nowrap class="h2"><hr></td></tr><tr><td><strong> <a href="https://jimandi.com/SDKWiki/index.php?title=Easy_Drawer_Maker" target="_blank" class="helpbutton">Help</a> </strong></td><td class="FormButton"><span style="width: 15%"> <input id = "ButtonOK" class = "FormButton" name = "ButtonOK" type = "button" value = "OK"> </span></td><td class="FormButton"><span style="width: 20%"> <input id = "ButtonCancel" class = "FormButton" name = "ButtonCancel" type = "button" value = "Cancel"> </span></td></tr></table></body></html>]]
  local dialog = HTML_Dialog(true, myHtml, 561, 270, "Project Setup")
  dialog:AddTextField("ProjectQuestion.ProjectName", ProjectQuestion.ProjectName)
  dialog:AddTextField("ProjectQuestion.ProjectContactEmail", ProjectQuestion.ProjectContactEmail)
  dialog:AddTextField("ProjectQuestion.ProjectContactName", ProjectQuestion.ProjectContactName)
  dialog:AddTextField("ProjectQuestion.ProjectContactPhoneNumber", ProjectQuestion.ProjectContactPhoneNumber)
  dialog:AddTextField("ProjectQuestion.DrawerID", StartDate())
  dialog:AddTextField("ProjectQuestion.ProjectPath", ProjectQuestion.ProjectPath )
  dialog:AddDirectoryPicker("DirectoryPicker", "ProjectQuestion.ProjectPath" , true)
  if dialog:ShowDialog() then
    ProjectQuestion.ProjectName = dialog:GetTextField("ProjectQuestion.ProjectName")
    ProjectQuestion.ProjectContactEmail = dialog:GetTextField("ProjectQuestion.ProjectContactEmail")
    ProjectQuestion.ProjectContactName = dialog:GetTextField("ProjectQuestion.ProjectContactName")
    ProjectQuestion.ProjectContactPhoneNumber = dialog:GetTextField("ProjectQuestion.ProjectContactPhoneNumber")
    ProjectQuestion.DrawerID = dialog:GetTextField("ProjectQuestion.DrawerID")
    ProjectQuestion.ProjectPath = dialog:GetTextField("ProjectQuestion.ProjectPath")
    DialogWindow.ProjectSetupXX0 = tostring(dialog.WindowWidth)
    DialogWindow.ProjectSetupYY0 = tostring(dialog.WindowHeight)
    REG_UpdateRegistry()
  end
  return  true
end
...
local myHtml = [[<html><head><title>Layer Names</title><style type="text/css">html{overflow:hidden} .helpbutton { background-color:#E1E1E1; border:1px solid #999; 	border-right-color:#000; border-bottom-color:#000; border-top-color:#FFF; border-left-color:#FFF; padding:2px 12px; font-family:Arial, Helvetica, sans-serif; text-align:center; text-decoration:none;	font-size:12px; margin:4px 2px;	color:#000 } .helpbutton:active {	border-right-color:#FFF; border-bottom-color:#FFF;	border-top-color:#000; border-left-color:#000} .helpbutton:hover {	border-right-color:#000; border-bottom-color:#000;	border-top-color:#FFF;	border-left-color:#FFF} .LuaButton{font-weight:bold;font-family:Arial,Helvetica,sans-serif;font-size:12px;vertical-align:middle} .DirectoryPicker{font-weight:bold;font-family:Arial,Helvetica,sans-serif;font-size:12px} .ToolPicker{font-weight:bold;text-align:center;font-family:Arial,Helvetica,sans-serif;font-size:12px} .ToolNameLabel{font-family:Arial,Helvetica,sans-serif;font-weight:bolder;font-size:12px;text-align:left;color:#FF0} .FormButton{font-weight:bold;width:75px;font-family:Arial,Helvetica,sans-serif;font-size:12px;white-space:nowrap} .h1-l{font-family:Arial,Helvetica,sans-serif;font-size:12px;text-align:left;white-space:nowrap} .h1-r{font-family:Arial,Helvetica,sans-serif;font-size:12px;text-align:right;white-space:nowrap} .alert{font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;color:#00F;text-align:center;white-space:nowrap} .h1-c{font-family:Arial,Helvetica,sans-serif;font-size:12px;text-align:center;white-space:nowrap}body{background-color:#CCC;overflow:hidden;font-family:Arial,Helvetica,sans-serif;font-size:12px}</style></head><body bgcolor = "#EBEBEB" text = "#000000"><table width="430" border="0" cellpadding="0" id="ValueTable"><tr><td align="right" valign="middle" nowrap class="h1-r"><span class="h1-r">Back Panel Profile</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><span class="h1-r"> <input name="Milling.LayerNameBackProfile" type="text" class="h1" id="Milling.LayerNameBackProfile" size="30" maxlength="50" /> </span></td></tr><tr><td align="right" valign="middle" nowrap class="h1-r"><span class="h1-r">BackPanel Pocket (Dado)</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><span class="h1-r"> <input name="Milling.LayerNameBackPocket" type="text" class="h1" id="Milling.LayerNameBackPocket" size="30" maxlength="50" /> </span></td></tr><tr><td align="right" valign="middle" nowrap class="h1-r"><span class="h1-r">Center Panel Profile</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><span class="h1-r"> <input name="Milling.LayerNameCenterPanelProfile" type="text" class="h1" id="Milling.LayerNameCenterPanelProfile" size="30" maxlength="50" /> </span></td></tr><tr><td align="right" valign="middle" nowrap class="h1-r"><span class="h1-r">Center Panel Shelf Pin Drilling</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><span class="h1-r"> <input name="Milling.LayerNameCenterPanelShelfPinDrill" type="text" class="h1" id="Milling.LayerNameCenterPanelShelfPinDrill" size="30" maxlength="50" /> </span></td></tr><tr><td align="right" valign="middle" nowrap class="h1-r"><span class="h1-r">Face Frame Drawing</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><span class="h1-r"> <input name="Milling.LayerNameDrawFaceFrame" type="text" class="h1" id="Milling.LayerNameDrawFaceFrame" size="30" maxlength="50" /> </span></td></tr><tr><td align="right" valign="middle" nowrap class="h1-r"><span class="h1-r">Cabinet Notes Drawing</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><span class="h1-r"> <input name="Milling.LayerNameDrawNotes" type="text" class="h1" id="Milling.LayerNameDrawNotes" size="30" maxlength="50" /> </span></td></tr><tr><td align="right" valign="middle" nowrap class="h1-r"><span class="h1-r">Shelf Profile</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><span class="h1-r"> <input name="Milling.LayerNameShelfProfile" type="text" class="h1" id="Milling.LayerNameShelfProfile" size="30" maxlength="50" /> </span></td></tr><tr><td align="right" valign="middle" nowrap class="h1-r"><span class="h1-r">Cabinet Side Profile</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><span class="h1-r"> <input name="Milling.LayerNameSideProfile" type="text" class="h1" id="Milling.LayerNameSideProfile" size="30" maxlength="50" /> </span></td></tr><tr><td align="right" valign="middle" nowrap class="h1-r"><span class="h1-r">Cabinet Side Pocket (Dado &amp Rabbet)</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><span class="h1-r"> <input name="Milling.LayerNameSidePocket" type="text" class="h1" id="Milling.LayerNameSidePocket" size="30" maxlength="50" /> </span></td></tr><tr><td align="right" valign="middle" nowrap class="h1-r"><span class="h1-r">Cabinet Side Shelf Pin Drilling</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><span class="h1-r"> <input name="Milling.LayerNameSideShelfPinDrill" type="text" class="h1" id="Milling.LayerNameSideShelfPinDrill" size="30" maxlength="50" /> </span></td></tr><tr><td align="right" valign="middle" nowrap class="h1-r"><span class="h1-r">Top &amp Bottom Profile</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><span class="h1-r"> <input name="Milling.LayerNameTopBottomProfile" type="text" class="h1" id="Milling.LayerNameTopBottomProfile" size="30" maxlength="50" /> </span></td></tr><tr><td align="right" valign="middle" nowrap class="h1-r"><span class="h1-r">Top &amp Bottom Pocket</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><span class="h1-r"> <input name="Milling.LayerNameTopBottomPocket" type="text" class="h1" id="Milling.LayerNameTopBottomPocket" size="30" maxlength="50" /> </span></td></tr><tr><td align="right" valign="middle" nowrap class="h1-r"><span class="h1-r">Stretcher &amp Rail Profile</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><span class="h1-r"> <input name="Milling.LayerNameStretcherRailProfile" type="text" class="h1" id="Milling.LayerNameStretcherRailProfile" size="30" maxlength="50" /> </span></td><tr><td align="right" valign="middle" nowrap class="h1-r"><span class="h1-r">Part Labels</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><span class="h1-r"> <input name="Milling.LayerNamePartLabels" type="text" class="h1" id="Milling.LayerNamePartLabels" size="30" maxlength="50" /> </span></td></tr></table><table width="430" border="0" id="ButtonTable"><tr><td height="12" colspan="3" align="right" valign="middle" nowrap class="h2"><hr></td></tr><tr><td><strong> <a href="https://jimandi.com/SDKWiki/index.php?title=Easy_Drawer_Maker" target="_blank" class="helpbutton">Help</a> </strong></td><td class="FormButton"><span style="width: 15%"> <input id = "ButtonOK" class = "FormButton" name = "ButtonOK" type = "button" value = "OK"> </span></td><td class="FormButton"><span style="width: 20%"> <input id = "ButtonCancel" class = "FormButton" name = "ButtonCancel" type = "button" value = "Cancel"> </span></td></tr></table></body></html>]]
  ...
  if  dialog:ShowDialog() then
    ...
    DialogWindow.LayerSetupXX0                = tostring(dialog.WindowWidth)
    DialogWindow.LayerSetupYY0                = tostring(dialog.WindowHeight)
    REG_UpdateRegistry()
  end
  return  true
end
...
local myHtml = [[<html><head><title>Milling Information</title><style type="text/css">html {overflow:hidden}.helpbutton {background-color:#E1E1E1;border:1px solid #999;border-right-color:#000;border-bottom-color:#000;border-top-color:#FFF;border-left-color:#FFF;padding:2px 12px;font-family:Arial, Helvetica, sans-serif;text-align:center;text-decoration:none;font-size:12px;margin:4px 2px;color:#000}.helpbutton:hover {border-right-color:#000;border-bottom-color:#000;border-top-color:#FFF;border-left-color:#FFF}.LuaButton {font-weight:bold;font-family:Arial, Helvetica, sans-serif;font-size:12px}.DirectoryPicker {font-weight:bold;font-family:Arial, Helvetica, sans-serif;font-size:12px}.ToolPicker {font-weight:bold;text-align:center;font-family:Arial, Helvetica, sans-serif;font-size:12px}.ToolNameLabel {font-family:Arial, Helvetica, sans-serif;font-weight:bolder;font-size:12px;text-align:left;color:#FF0}.FormButton {font-weight:bold;width:75px;font-family:Arial, Helvetica, sans-serif;font-size:12px;white-space:nowrap}.h1-l {font-family:Arial, Helvetica, sans-serif;font-size:12px;text-align:left;white-space:nowrap}.h1-r {font-family:Arial, Helvetica, sans-serif;font-size:12px;text-align:right;white-space:nowrap}.h1-rP {font-family:Arial, Helvetica, sans-serif;font-size:12px;text-align:right;white-space:nowrap;padding-right:4px;padding-left:4px}.h1-rPx {font-family:Arial, Helvetica, sans-serif;font-size:12px;text-align:right;white-space:nowrap;padding-right:8px;padding-left:8px}.alert {font-family:Arial, Helvetica, sans-serif;font-size:12px;font-weight:bold;color:#00F;text-align:center;white-space:nowrap}.h1-c {font-family:Arial, Helvetica, sans-serif;font-size:12px;text-align:center;white-space:nowrap}body {background-color:#CCC;overflow:hidden;font-family:Arial, Helvetica, sans-serif;font-size:12px}.h1-r1 {font-family:Arial, Helvetica, sans-serif;font-size:12px;text-align:right;white-space:nowrap}</style></head><body bgcolor = "#EBEBEB" text = "#000000"><table width="456" border="0" cellpadding="0"> <tr> <td width="130" align="right" valign="middle" nowrap class="h1-rP">Back Dado Height</td> <td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="Milling.DadoBackHeight" type="text" class="h2" id="Milling.DadoBackHeight" size="10" maxlength="10" /></td> <td width="130" align="right" valign="middle" nowrap class="h1-rP">Dado Height</td> <td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="Milling.DadoHeight" type="text" class="h2" id="Milling.DadoHeight" size="10" maxlength="10" /></td> </tr> <tr> <td width="130" align="right" valign="middle" nowrap class="h1-rP">Dado Clearance</td> <td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="Milling.DadoClearance" type="text" class="h2" id="Milling.DadoClearance" size="10" maxlength="10" /></td> <td width="130" align="right" valign="middle" nowrap class="h1-rP">Rabbit Clearance</td> <td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="Milling.RabbitClearance" type="text" class="h2" id="Milling.RabbitClearance" size="10" maxlength="10" /></td> </tr> <tr> <td width="130" align="right" valign="middle" nowrap class="h1-rP">Part Gap</td> <td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="Milling.PartGap" type="text" class="h2" id="Milling.PartGap" size="10" maxlength="10" /></td> <td width="130" align="right" valign="middle" nowrap class="h1-rP">Shelf Pin Diameter</td> <td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="Milling.ShelfPinDiameter" type="text" class="h2" id="Milling.ShelfPinDiameter" size="10" maxlength="10" /></td> </tr> <tr> <td align="right" valign="middle" nowrap class="h1-r">&nbsp;</td> <td align="right" valign="middle" nowrap class="h1-l">&nbsp;</td> <td align="right" valign="middle" nowrap class="h1-rP">Shelf Pin Length</td> <td align="right" valign="middle" nowrap class="h1-l"><input name="Milling.ShelfPinLen" type="text" class="h2" id="Milling.ShelfPinLen" size="10" maxlength="10" /></td> </tr></table><table width="456" border="0"> <tr> <td colspan="3"><hr></td> </tr> <tr> <td><strong> <a href="https://jimandi.com/SDKWiki/index.php?title=Easy_Drawer_Maker" target="_blank" class="helpbutton">Help</a> </strong></td> <td class="FormButton"><span style="width: 15%"> <input id = "ButtonOK" class = "FormButton" name = "ButtonOK" type = "button" value = "OK"> </span></td> <td class="FormButton"><span style="width: 20%"> <input id = "ButtonCancel" class = "FormButton" name = "ButtonCancel" type = "button" value = "Cancel"> </span></td> </tr></table></body></html>]]
  ...
  if dialog:ShowDialog() then
    ...
    DialogWindow.MillingSettingXX0 = tostring(dialog.WindowWidth)
    DialogWindow.MillingSettingYY0 = tostring(dialog.WindowHeight)
    REG_UpdateRegistry()
  end
  return  true
end
...
local myHtml = [[<html><head><title>Base Cabinet Setup</title><style type="text/css">html{overflow:hidden} .helpbutton { 	background-color:#E1E1E1; 	border:1px solid #999; 	border-right-color:#000; 	border-bottom-color:#000; 	border-top-color:#FFF; 	border-left-color:#FFF; 	padding:2px 12px; 	font-family:Arial, Helvetica, sans-serif; 	text-align:center;	text-decoration:none;	font-size:12px; margin:4px 2px;	color:#000 } .helpbutton:active {	border-right-color:#FFF;	border-bottom-color:#FFF;	border-top-color:#000;	border-left-color:#000} .helpbutton:hover {	border-right-color:#000;	border-bottom-color:#000;	border-top-color:#FFF;	border-left-color:#FFF} .LuaButton{font-weight:bold;font-family:Arial,Helvetica,sans-serif;font-size:12px} .DirectoryPicker{font-weight:bold;font-family:Arial,Helvetica,sans-serif;font-size:12px} .ToolPicker{font-weight:bold;text-align:center;font-family:Arial,Helvetica,sans-serif;font-size:12px} .ToolNameLabel{font-family:Arial,Helvetica,sans-serif;font-weight:bolder;font-size:12px;text-align:left;color:#FF0} .FormButton{font-weight:bold;width:75px;font-family:Arial,Helvetica,sans-serif;font-size:12px;white-space:nowrap} .h1-l{font-family:Arial,Helvetica,sans-serif;font-size:12px;text-align:left;white-space:nowrap} .h1-r{font-family:Arial,Helvetica,sans-serif;font-size:12px;text-align:right;white-space:nowrap} .alert{font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:bold;color:#00F;text-align:center;white-space:nowrap} .h1-c{font-family:Arial,Helvetica,sans-serif;font-size:12px;text-align:center;white-space:nowrap} .header1-c{font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:bold;text-align:center;white-space:nowrap} .header2-c{font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:bold;text-align:center;white-space:nowrap}body{background-color:#CCC;overflow:hidden;font-family:Arial,Helvetica,sans-serif;font-size:12px}</style></head><body bgcolor = "#EBEBEB" text = "#000000"><table width="500" border="0" cellpadding="0" id="ValueTable"><tr><td width="180" align="right" valign="middle" nowrap class="h1-r"> Face Frame Rail Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameBottomRailWidth" type="text" class="h2" id="BaseDim.FaceFrameBottomRailWidth" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Bottom Reveal</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameBottomReveal" type="text" class="h2" id="BaseDim.FaceFrameBottomReveal" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Center Stile Face Frame Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameCenterStileWidth" type="text" class="h2" id="BaseDim.FaceFrameCenterStileWidth" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Side Reveal</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameSideReveal" type="text" class="h2" id="BaseDim.FaceFrameSideReveal" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Stile Face Frame Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameStileWidth" type="text" class="h2" id="BaseDim.FaceFrameStileWidth" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Drawer Height1</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameDrawerHeight1" type="text" class="h2" id="BaseDim.FaceFrameDrawerHeight1" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Top Rail Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameTopRailWidth" type="text" class="h2" id="BaseDim.FaceFrameTopRailWidth" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Drawer Height2</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameDrawerHeight2" type="text" class="h2" id="BaseDim.FaceFrameDrawerHeight2" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Material Thickness Back</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ThicknessBack" type="text" class="h2" id="BaseDim.ThicknessBack" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Drawer Height3</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameDrawerHeight3" type="text" class="h2" id="BaseDim.FaceFrameDrawerHeight3" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Mid Rail Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameMidRailWidth" type="text" class="h2" id="BaseDim.FaceFrameMidRailWidth" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Thickness</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameThickness" type="text" class="h2" id="BaseDim.FaceFrameThickness" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Face Frame Thickness</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfFaceFrameThickness" type="text" class="h2" id="BaseDim.ShelfFaceFrameThickness" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Cabinet Material Thickness</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.MaterialThickness" type="text" class="h2" id="BaseDim.MaterialThickness2" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf End Clarence</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfEndClarence" type="text" class="h2" id="BaseDim.ShelfEndClarence" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Clearance Front</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfFrontClearance" type="text" class="h2" id="BaseDim.ShelfFrontClearance" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Hole First Row Spacing</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfHoleFirstRowSpacing" type="text" class="h2" id="BaseDim.ShelfHoleFirstRowSpacing" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Material Thickness</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfMaterialThickness" type="text" class="h2" id="BaseDim.ShelfMaterialThickness" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Pin Hole Front</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfPinHoleFront" type="text" class="h2" id="BaseDim.ShelfPinHoleFront" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Face Frame Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfFaceFrameWidth" type="text" class="h2" id="BaseDim.ShelfFaceFrameWidth" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Hole Spacing</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfHoleSpacing" type="text" class="h2" id="BaseDim.ShelfHoleSpacing" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Pin Hole Back</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfPinHoleBack" type="text" class="h2" id="BaseDim.ShelfPinHoleBack" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Hole Last Row Spacing</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfHoleLastRowSpacing" type="text" class="h2" id="BaseDim.ShelfHoleLastRowSpacing" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Stretcher Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.StretcherWidth" type="text" class="h2" id="BaseDim.StretcherWidth" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Toe Kick Bottom Offset Height</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ToeKickBottomOffsetHeight" type="text" class="h2" id="BaseDim.ToeKickBottomOffsetHeight" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Stretcher Thickness</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.StretcherThickness" type="text" class="h2" id="BaseDim.StretcherThickness" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Toe Kick Depth</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ToeKickDepth" type="text" class="h2" id="BaseDim.ToeKickDepth" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Toe Kick Height</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ToeKickHeight" type="text" class="h2" id="BaseDim.ToeKickHeight" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Top Frame Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.TopFrameWidth" type="text" class="h2" id="BaseDim.TopFrameWidth" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Add Center Panel:</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><select name="BaseQuestion.AddCenterPanel" size="1" id="BaseQuestion.AddCenterPanel"><option selected>Yes</option><option>No</option> </select></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Drawer Row Count</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseQuestion.DrawerRowCount" type="text" class="h2" id="BaseQuestion.DrawerRowCount" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Count</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseQuestion.ShelfCount" type="text" class="h2" id="BaseQuestion.ShelfCount" size="10" maxlength="10" /></td></tr></table><table width="560" border="0" id="ButtonTable"><tr><td height="12" colspan="3" align="right" valign="middle" nowrap class="h2"><hr></td></tr><tr><td><strong> <a href="https://jimandi.com/SDKWiki/index.php?title=Easy_Drawer_Maker" target="_blank" class="helpbutton">Help</a> </strong></td><td class="FormButton"><span style="width: 15%"> <input id = "ButtonOK" class = "FormButton" name = "ButtonOK" type = "button" value = "OK"> </span></td><td class="FormButton"><span style="width: 20%"> <input id = "ButtonCancel" class = "FormButton" name = "ButtonCancel" type = "button" value = "Cancel"> </span></td></tr></table></body></html>]]
  ...
  if dialog:ShowDialog() then
    ...
    BaseQuestion.ShelfCount  = dialog:GetIntegerField("BaseQuestion.ShelfCount")
    BaseQuestion.DrawerRowCount = dialog:GetIntegerField("BaseQuestion.DrawerRowCount")
    ...
    DialogWindow.BaseCabinetSetupXX0 = tostring(dialog.WindowWidth)
    DialogWindow.BaseCabinetSetupYY0 = tostring(dialog.WindowHeight)
    REG_UpdateRegistry()
  end
  Base_Math()
  REG_UpdateRegistry()
...
function OnLuaButton_InquiryWallQuestion()
  ...
  dialog:AddIntegerField("WallQuestion.ShelfCount", WallQuestion.ShelfCount)
 ...
 -- dialog:AddDoubleField("WallDim.StretcherThickness", WallDim.StretcherThickness)
 -- dialog:AddDoubleField("WallDim.StretcherWidth", WallDim.StretcherWidth)
  ...
  if dialog:ShowDialog() then
    ...
    WallQuestion.ShelfCount  = dialog:GetIntegerField("WallQuestion.ShelfCount")
 ...
 --   WallDim.StretcherThickness = dialog:GetDoubleField("WallDim.StretcherThickness")
 --   WallDim.StretcherWidth = dialog:GetDoubleField("WallDim.StretcherWidth")
    ...
    DialogWindow.WallCabinetSetupXX0 = tostring(dialog.WindowWidth)
    DialogWindow.WallCabinetSetupYY0 = tostring(dialog.WindowHeight)
    Wall_Math()
    REG_UpdateRegistry()
  end
  return  true
...
function Wall_CabinetFaceFrame()
  ...
  DrawWriter(ProjectQuestion.ProgramName, pt1Text, 1.250, Milling.LayerNameDrawNotes, 0.0)
  pt1Text = Polar2D(pt1Text, 270, 1.25)
  DrawWriter("Cabinet ID: " .. ProjectQuestion.DrawerID, pt1Text, 0.750, Milling.LayerNameDrawNotes, 0.0)
  pt1Text = Polar2D(pt1Text, 270,1)
  DrawWriter("Cabnet Name: " .. ProjectQuestion.CabinetName, pt1Text, 0.750, Milling.LayerNameDrawNotes, 0.0)
  pt1Text = Polar2D(pt1Text, 270,1)
  DrawWriter("Version: " .. ProjectQuestion.ProgramVersion, pt1Text, 0.750, Milling.LayerNameDrawNotes, 0.0)
  pt1Text = Polar2D(pt1Text, 270,1)
  DrawWriter("Gadget By: " .. ProjectQuestion.ProgramCodeBy, pt1Text, 0.750, Milling.LayerNameDrawNotes, 0.0)
  return true
end  --  function end
--  ===================================================]]
function CutListfileWriterHeader(Cab)
  local file = io.open(ProjectQuestion.ProjectPath .. "\\" .. ProjectQuestion.CabinetName .. "-".. ProjectQuestion.DrawerID.. ".dat", "w")
  file:write("=============================================================================================== \n")
  ...
  file:write("=============================================================================================== \n")
  file:close()
  file = io.open(ProjectQuestion.ProjectPath .. "\\" .. ProjectQuestion.CabinetName .."-".. ProjectQuestion.DrawerID..  ".csv", "w")
...
function CutListfileWriterItem(ID, Name, Count, Thick, Material, Width, Length)
  local file = io.open(ProjectQuestion.ProjectPath .. "\\" .. ProjectQuestion.CabinetName .. "-".. ProjectQuestion.DrawerID.. ".dat", "a")
  local sID = " " .. ID .. " "
  ...
  file:close()
  file = io.open(ProjectQuestion.ProjectPath .. "\\" .. ProjectQuestion.CabinetName ..  "-".. ProjectQuestion.DrawerID.. ".csv", "a")
  file:write(ID .. "," .. Name .. "," .. Count .. "," .. Thick .. "," .. Material .. "," .. Width .. "," .. Length  .. "  \n")
  file:close()
end
--  ===================================================]]
...
function main()
  ...
  if ProjectQuestion.ProjectPath  ==  "Default" then
    ...
    if ProjectQuestion.NewSheet == "YES" then
      Milling.Sheet = "1-"
      NewSheet()
    else
      Milling.Sheet = ""
    ...
    if Drawing == "WALL" then
      ProjectQuestion.Drawing = "WALL"
    end -- if end
    if Drawing == "BASE" then
      ProjectQuestion.Drawing = "BASE"
    end -- if end
    if Drawing == "BOTH" then
      ProjectQuestion.Drawing = "WALL"
    end -- if end
    if ProjectQuestion.Drawing == "WALL" then
      if Drawing == "BOTH" then
        ProjectQuestion.Drawing = "BASE"
      end -- if end
      MakeLayers("-Wall")
...
--  ===================================================]]
    if ProjectQuestion.Drawing == "BASE" then
      MakeLayers("-Base")
      if Drawing == "BOTH" then
        if ProjectQuestion.NewSheet == "YES" then
          NewSheet()
