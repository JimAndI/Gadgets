...
function REG_ReadRegistry()  -- Read from Registry values
  ...
  Milling.LNDrawNotes        = RegistryRead:GetString("Milling.LNDrawNotes",     "LabelNotes")
...
function InquiryDrawer(Header)
  Drawer.dialog = HTML_Dialog(true, DialogWindow.myHtml1, 582, 464,  Header)
...
function OnLuaButton_InquiryLayers()
  local dialog = HTML_Dialog(true, DialogWindow.myHtml2, 560, 365, "Layer Setup") ;
...
.LuaButton {font-weight:bold; width:75px; font-family:Arial, Helvetica, sans-serif;font-size:12px; background-color:  ]].. DialogWindow.StyleButtonColor ..[[ ;color: ]].. DialogWindow.StyleButtonTextColor .. [[ }
