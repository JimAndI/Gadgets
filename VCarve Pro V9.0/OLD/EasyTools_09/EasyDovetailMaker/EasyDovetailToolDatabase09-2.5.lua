...
function Writex()                                       -- Write to Registry values
  ...
  local RegValue = RegistryWrite:SetString("Bit001-BitName", "Amana Tool 45804 Carbide Tipped Dovetail 14 Deg x 0.5 D x 0.5 CH x 0.25 SHK")
        RegValue = RegistryWrite:SetString("AppInfo", "Easy Dovetail Tool Database Gadget. Data Schema Ver:".. Dovetail.SchemaVersion .. " Application Ver: ".. Dovetail.Version .." (Writen by: James Anderson)")
