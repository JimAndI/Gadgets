...
function main(script_path)
  ...
  -- Loop over the selected ids and build up a list of ungrouped ids
  local ungrouped_ids = UUID_List()
  ...
  while pos do
    ...
    -- If we have the object and it can't be cast to a group
    -- then add it to our list of ungrouped ids
    if object and not CastComponentToComponentGroup(object) then
      ungrouped_ids:AddTail(id)
    end
  end
  
  -- Now group these objects
  component_manager:GroupObjectsWithIds(ungrouped_ids)
