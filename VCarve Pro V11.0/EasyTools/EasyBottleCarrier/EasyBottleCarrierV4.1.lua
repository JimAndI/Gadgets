...
-- Easy Bottle Carrier Maker is written by JimAndi Gadgets of Houston Texas 2019
]]
-- =====================================================]]
-- Global variables
...
function CarrierDialog(Header)
  --[[
      ...
      Caller = local x = InquiryTextBox("Cabinet Maker", "Enter your last name?", "Miller")
      Dialog Header = "Cabinet Maker"
      User Question = "Enter your last name?"
      Default Question = Miller
      Returns = String
  ]]
    local SDK = "http://www.jimandi.com/EasyGadgets/EasyBottleCarrier/Help/index.html"
...
--  Call Display dialogue --
  ...
  if Carrier.Inquiry then
    ...
    if type(Carrier.MillTool1) == "userdata" then
      ...
      if Carrier.Tabs then
        CreateLayerProfileToolpath(job,   "Hole"   , "Hole (Add Tabs)"   , 0.0, Carrier.MaterialBlockThickness        , "IN" , Carrier.Tabs)
        CreateLayerProfileToolpath(job,   "Profile", "Profile (Add Tabs)", 0.0, Carrier.MaterialBlockThickness        , "OUT", Carrier.Tabs)
      else
        CreateLayerProfileToolpath(job,   "Hole"   , "Hole"   , 0.0, Carrier.MaterialBlockThickness        , "IN" , Carrier.Tabs)
        CreateLayerProfileToolpath(job,   "Profile", "Profile", 0.0, Carrier.MaterialBlockThickness        , "OUT", Carrier.Tabs)
      end -- if end
