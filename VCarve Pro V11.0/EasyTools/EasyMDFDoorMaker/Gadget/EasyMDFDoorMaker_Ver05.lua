...
-- Version 5.0    - July 8, 2021
-- Version 6.0    - July 10, 2021
-- ====================================================]]
-- Global variables
...
--[[
  DebugMarkPoint("ptA1", ptA1, 3, "Debug")
  DebugMarkPoint("ptA2", ptA2, 3, "Debug")
  DebugMarkPoint("ptA3", ptA3, 3, "Debug")
  DebugMarkPoint("ptA4", ptA4, 3, "Debug")
  DebugMarkPoint("ptA5", ptA5, 3, "Debug")
  DebugMarkPoint("ptA6", ptA6, 3, "Debug")
  DebugMarkPoint("ptA7", ptA7, 3, "Debug")
  DebugMarkPoint("ptA1", ptA1, 3, "Debug")
...
--  local Hdis = GetDistance(ptR, ptL) * 0.5
  ...
  local fltCount = (((GetDistance(ptR, ptL) - (Rad * 2.0)) + ( Door.BitRad * 2.0)) / StyleG.FluteSpacing)
...
--  local Vdis = GetDistance(ptT, ptB) * 0.5
  local Hdis = GetDistance(ptR, ptL) * 0.5
  local Rad  = StyleG.C + Door.BitRad
  local fltCount = (((GetDistance(ptT, ptB) - (Rad * 2.0)) + ( Door.BitRad * 2.0)) / StyleG.FluteSpacing)
...
function OnLuaButton_InquiryImport(dialog)
  Door.RuntimeLog = "CSVImportLog" .. StartDateTime(true)
