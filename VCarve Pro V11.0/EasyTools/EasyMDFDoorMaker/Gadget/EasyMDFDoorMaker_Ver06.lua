...
Door.Row            = 0.0
Door.RowCount       = 1
DialogWindow.ProjectSDK = "https://github.com/JimAndI/EasyMDFDoorMaker/wiki"
-- =====================================================]]
...
function DoorStyleGVertical(pt1)
  ...
  local fltCount = (((GetDistance(ptR, ptL) - (Rad * 2.0)) + ( Door.BitRad * 2.0)) / StyleG.FluteSpacing) -1
...
function DoorStyleGHorizontal(pt1)
  ...
  local Hdis = GetDistance(ptR, ptL) * 0.5
  local Rad  = StyleG.C + Door.BitRad
  local fltCount = (((GetDistance(ptT, ptB) - (Rad * 2.0)) + ( Door.BitRad * 2.0)) / StyleG.FluteSpacing) - 1
