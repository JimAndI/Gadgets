...
function DoorStyleA()                                  -- Draws a Shaker Style Door
  ...
  Door.pt05A = Polar2D(Door.pt05, 270.0, StyleA.B)
  Door.pt06A = Polar2D(Door.pt06, 270.0, StyleA.B)
  Door.pt07A = Polar2D(Door.pt07,  90.0, StyleA.B)
  Door.pt08A = Polar2D(Door.pt08,  90.0, StyleA.B)
  ...
  if (WidthCheck) and (HeightCheck) then
    ...
    if Door.ScribeLines == "Yes" then
      ...
      DrawLine(Door.pt06, Door.pt06A, Door.LayerScribeLines)
      DrawLine(Door.pt07, Door.pt07A, Door.LayerScribeLines)
      DrawLine(Door.pt08, Door.pt08A, Door.LayerScribeLines)
    end -- if end
  else
...
function DoorStyleB()                                  -- Draws a Cathedral Style Door
  ...
  Door.pt05A = Polar2D(Door.pt05, 270.0, StyleB.C)
  Door.pt06A = Polar2D(Door.pt06, 270.0, StyleB.C)
  Door.pt07A = Polar2D(Door.pt07,  90.0, StyleB.B)
  Door.pt10A = Polar2D(Door.pt10,  90.0, StyleB.B)
  ...
  if (WidthCheck) and (HeightCheck) then
    ...
    if Door.ScribeLines == "Yes" then
      ...
      DrawLine(Door.pt06, Door.pt06A, Door.LayerScribeLines)
      DrawLine(Door.pt07, Door.pt07A, Door.LayerScribeLines)
      DrawLine(Door.pt10, Door.pt10A, Door.LayerScribeLines)
    end -- if end
...
function DoorStyleC()                                  -- Draws a Double Cathedral Style Door
  ...
  Door.pt05A = Polar2D(Door.pt05, 270.0, StyleC.B)
  Door.pt06A = Polar2D(Door.pt06, 270.0, StyleC.B)
  Door.pt07A = Polar2D(Door.pt07,  90.0, StyleC.B)
  Door.pt10A = Polar2D(Door.pt10,  90.0, StyleC.B)
...
function DoorStyleE()                                 -- Draws a Arched Style Door
  ...
  Door.pt05A = Polar2D(Door.pt05, 270.0, StyleE.C)
  Door.pt06A = Polar2D(Door.pt06, 270.0, StyleE.C)
  Door.pt07A = Polar2D(Door.pt07,  90.0, StyleE.B)
  Door.pt08A = Polar2D(Door.pt08,  90.0, StyleE.B)
...
function DoorStyleF()                                 -- Draws a Arched Style Door
  ...
  Door.pt05A = Polar2D(Door.pt05, 270.0, StyleF.B)
  Door.pt06A = Polar2D(Door.pt06, 270.0, StyleF.B)
  Door.pt07A = Polar2D(Door.pt07,  90.0, StyleF.B)
  Door.pt08A = Polar2D(Door.pt08,  90.0, StyleF.B)
  Door.Chor = GetDistance(Door.pt07, Door.pt08)
...
function DoorStyleG()                                  -- Draws a Corner Radius Style Door
  ...
  local pt05A = Polar2D(pt12, 270.0, StyleG.B + StyleG.C)
  local pt06A = Polar2D(pt7, 270.0, StyleG.B + StyleG.C)
  local pt07A = Polar2D(pt11,  90.0, StyleG.B + StyleG.C)
  local pt08A = Polar2D(pt8,  90.0, StyleG.B + StyleG.C)
  ...
  if (Door.Width > (StyleG.A * 2.0) + (StyleG.C * 2.0)) and  (Door.Height > (StyleG.B * 2.0) + (StyleG.C * 2.0)) then
    if (Door.Width > (StyleG.A * 2.0) + (StyleG.C * 2.0)) then
      ...
      if Door.ScribeLines == "Yes" then
        ...
        DrawLine(pt7, pt06A, Door.LayerScribeLines)
        DrawLine(pt11, pt07A, Door.LayerScribeLines)
...
function InquiryMain()
  Maindialog = HTML_Dialog(true, DialogWindow.Main, 650, 351, "MDF Door Maker Main Screen (Ver: " .. Version .. ")")
  Door.Alert = ""
  ...
  Maindialog:AddDropDownList("Door.ScribeLines",  Door.ScribeLines)
  ...
  if not Maindialog:ShowDialog() then
    ...
    Door.ScribeLines = Maindialog:GetDropDownListValue("Door.ScribeLines")
    Registry_Update()
    return false
  else
...
function OnLuaButton_InquiryDefault()
  local ErrorText = ""
  local dialog = HTML_Dialog(true, DialogWindow.myHtml1, 632, 400, "Default Settings")
...
function Registry_Update()                              -- Write to Registry values
    ...
    local RegValue = RW:SetString("DialogWindow.HelpXY",               DialogWindow.HelpXY)
          ...
          RegValue = RW:SetString("Door.LayerScribeLines",             Door.LayerScribeLines)
          RegValue = RW:SetString("Door.Fluting",                      Door.Fluting)
          RegValue = RW:SetString("Door.ScribeLines",                  Door.ScribeLines)
