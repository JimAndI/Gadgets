...
-- Version 11.9   - Nov 24, 2021 - Fixed Drill Holes Stacking
-- Version 12.0   - Nov 27, 2021 - Added No Face Frame option
-- Version 12.1   - Nov 28, 2021 - Bug fix
-- Version 12.2   - Dec  4, 2021 - Blind Rabbits & Dados
-- Version 12.3   - Dec  5, 2021 - Bug fix
-- =====================================================]]
...
function OnLuaButton_InquiryMilling()
  ...
  dialog:AddDropDownList("Milling.PinsOn32mm",           ifT(Milling.PinsOn32mm))
  ...
  if dialog:ShowDialog() then
    ...
    Milling.PinsOn32mm           = ifY(dialog:GetDropDownListValue("Milling.PinsOn32mm"))
...
function main(script_path)
  ...
  if (Milling.AddAssemblyHolesBase or Milling.AddAssemblyHolesWall) and Milling.AddAssemblyHolesToolpath then
