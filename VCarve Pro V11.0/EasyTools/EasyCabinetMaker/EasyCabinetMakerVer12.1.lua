...
-- Version 12.1   - Nov 28, 2021 - Bugfis
-- =====================================================]]
...
function OnLuaButton_InquiryMilling()
  local dialog = HTML_Dialog(true, DialogWindow.myHtml3 , 620, 323, "Milling Setting ")
...
function OnLuaButton_InquiryProjectInfo()
  local dialog = HTML_Dialog(true, DialogWindow.myHtml2, 651, 493, "Project Setup")
