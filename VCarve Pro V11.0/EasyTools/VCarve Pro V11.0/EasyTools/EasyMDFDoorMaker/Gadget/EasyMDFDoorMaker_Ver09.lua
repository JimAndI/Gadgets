...
function DoorSetUp(style)
  ...
  DebugMarkPoint("Door.pt01",  Door.pt01, 4, "Debug")
  DebugMarkPoint("Door.pt02",  Door.pt02, 4, "Debug")
  DebugMarkPoint("Door.pt03",  Door.pt03, 4, "Debug")
  DebugMarkPoint("Door.pt04",  Door.pt04, 4, "Debug")
  ...
  DebugMarkPoint("Door.Lctr",  Door.Lctr, 4, "Debug")
  DebugMarkPoint("Door.Rctr",  Door.Rctr, 4, "Debug")
  DebugMarkPoint("Door.Tctr",  Door.Tctr, 4, "Debug")
  DebugMarkPoint("Door.Bctr",  Door.Bctr, 4, "Debug")
  ...
  DebugMarkPoint("Door.pt05",  Door.pt05, 4, "Debug")
  DebugMarkPoint("Door.pt06",  Door.pt06, 4, "Debug")
  DebugMarkPoint("Door.pt07",  Door.pt07, 4, "Debug")
  DebugMarkPoint("Door.pt08",  Door.pt08, 4, "Debug")
...
function DoorStyleB()                                  -- Draws a Cathedral Style Door
  ...
  Door.pt08 = Polar2D(Door.pt07, 180.0, StyleB.B)
  Door.pt10 = Polar2D(Door.pt05,  90.0, (Door.Height - (StyleB.B + StyleB.C)))
  Door.pt09 = Polar2D(Door.pt10,   0.0, StyleB.B)
  ...
  DebugMarkPoint("Door.pt07",  Door.pt07, 4, "Debug")
  DebugMarkPoint("Door.pt08",  Door.pt08, 4, "Debug")
  DebugMarkPoint("Door.pt09",  Door.pt09, 4, "Debug")
  DebugMarkPoint("Door.pt10",  Door.pt10, 4, "Debug")
  DebugMarkPoint("Door.pt11",  Door.pt11, 4, "Debug")
  DebugMarkPoint("Door.pt12",  Door.pt12, 4, "Debug")
  DebugMarkPoint("Door.ptT",  Door.ptT, 4, "Debug")
  DebugMarkPoint("Door.ptB",  Door.ptB, 4, "Debug")
  DebugMarkPoint("Door.ptR",  Door.ptR, 4, "Debug")
  DebugMarkPoint("Door.ptL",  Door.ptL, 4, "Debug")
...
function DoorStyleBVertical()
  ...
  if Door.Arch then
    ...
    DebugMarkPoint("ChordPt", Polar2D(Door.ptT, 180.0, Door.Chord * 0.5), 4, "Debug")
    DebugMarkPoint("ChordPt", Polar2D(Door.ptT,   0.0, Door.Chord * 0.5), 4, "Debug")
  else
    DrawLine(Door.ptT,  Door.ptB, Door.LayerFlutes)
  end
 ...
 local seg, chord
  ...
  if (1.0 < fltCount) then
    while fltCount > 1 do
      ...
      fltCount = fltCount - 2
      DebugMarkPoint("Door.CHTX", Door.CHT, 5, "Debug")
    end -- while end
    if Door.Arch then
      ...
      DebugMarkPoint("ChordPt", Polar2D(Door.ptT, 180.0, chord * 0.5), 4, "Debug")
      DebugMarkPoint("ChordPt", Polar2D(Door.ptT,   0.0, chord * 0.5), 4, "Debug")
...
function DoorStyleC()                                  -- Draws a Double Cathedral Style Door
  ...
  DebugMarkPoint("Door.pt11",  Door.pt11, 4, "Debug")
  DebugMarkPoint("Door.pt12",  Door.pt12, 4, "Debug")
  DebugMarkPoint("Door.pt13",  Door.pt13, 4, "Debug")
  DebugMarkPoint("Door.pt14",  Door.pt14, 4, "Debug")
  DebugMarkPoint("Door.ptT",  Door.ptT, 4, "Debug")
  DebugMarkPoint("Door.ptB",  Door.ptB, 4, "Debug")
  DebugMarkPoint("Door.ptR",  Door.ptR, 4, "Debug")
  DebugMarkPoint("Door.ptL",  Door.ptL, 4, "Debug")
  ...
  if LegCheck1 then
    ...
    if (1.0 < fltCount1 + fltCount2) and LegCheck1 then
      while fltCount2 > 1 do
        ...
        DebugMarkPoint("Door.CHBX", Door.CHB, 5, "Debug")
      end -- while end
