...
<table>
  <tr>
    <th colspan="2" class="h3-l">Input DXF File</th>
  </tr>
  <tr>
    <th class="my-r"><input name = "ReadFile" type = "text" id = "ReadFile" size = "70" readonly bgcolor="#D6D6D6"></th>
    <th align = "left" valign = "middle"><span style="width: 15%">

      <input name = "FilePickerButton"  type = "button" class="FilePicker" id = "FilePickerButton"  value = "File">
...
<table>
  <tr>
    <th height="19" colspan="2" align = "right" valign = "middle" id = "QuestionID4"><hr></th>
  </tr>
</table>
<table>
  <tr>
    <th colspan="2" class="h3-l">Output Lua File</th>
  </tr>
  <tr>
    <th class="my-r"><input name = "WritePath" type = "text" id = "WritePath" size = "70" readonly bgcolor="#D6D6D6"></th>

    <th align = "left" valign = "middle"><span style="width: 15%">

      <input name = "FilePickerButton2" type = "button" class="FilePicker" id = "FilePickerButton2" value = "File">
      </span></th>
  </tr>
</table>
<table>
  <tr>
    <th colspan="2" align = "right" valign = "middle"><hr></th>
  </tr>
  <tr>
    <td colspan = "2" align = "center" valign = "middle"><table border = "0" width = "100%">
        <tr align = "right">
          <td style = "width: 20%"></td>
          <td style = "width: 20%"></td>
          <td style = "width: 25%"></td>
          <td style = "width: 15%"><input id = "ButtonCancel" class = "FormButton" name = "ButtonCancel" type = "button" value = "Cancel"></td>
          <td style = "width: 15%"><input id = "ButtonOK" class = "FormButton" name = "ButtonOK" type = "button" value = "OK"></td>
        </tr>
      </table></td>
  </tr>
</table>
  ...
  local dialog = HTML_Dialog(true, myHtml, 538, 240, AppName)
...
function FileHead(Layer) -- Starts New Object
  -- ContureHead(C:\Temp\, "23.3,12.5", "TestLayer")
    ...
    file:write("function DrawThis(job) \n")
