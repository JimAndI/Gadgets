...
function main(script_path)
  ...
  Tooler1 = assert(loadfile(script_path .. "\\EasyCabinetToolVer"     .. VerNumber .. ".xlua")) (Tooler1) -- Load Tooll Function
  Tooler2 = assert(loadfile(script_path .. "\\EasyCabinetWallVer"     .. VerNumber .. ".xlua")) (Tooler2) -- Load Tool2 Function
  Tooler3 = assert(loadfile(script_path .. "\\EasyCabinetBaseVer"     .. VerNumber .. ".xlua")) (Tooler3) -- Load Tool3 Function
  Tooler4 = assert(loadfile(script_path .. "\\EasyCabinetLibraryVer"  .. VerNumber .. ".xlua")) (Tooler4) -- Load Tool4 Function
  Tooler5 = assert(loadfile(script_path .. "\\EasyCabinetHardwareVer" .. VerNumber .. ".xlua")) (Tooler5) -- Load Tool5 Function
  Tooler6 = assert(loadfile(script_path .. "\\EasyCabinetImagesVer"   .. VerNumber .. ".xlua")) (Tooler6) -- Load Tool6 Function
  Tooler7 = assert(loadfile(script_path .. "\\EasyCabinetDialogVer"   .. VerNumber .. ".xlua")) (Tooler7) -- Load Tool7 Function
  Tooler8 = assert(loadfile(script_path .. "\\EasyCabinetRegistryVer" .. VerNumber .. ".xlua")) (Tooler8) -- Load Tool8 Function
  Images()
  HTML()
  GetMaterialSettings()
  RegistryRead()
