...
-- Version 11.1   - Aug 10, 2021 - Add code and fixed issues
-- =====================================================]]
-- Global variables
--require("mobdebug").start()
require "strict"
local Tooler1, Tooler2, Tooler3
YearNumber = "2021"
VerNumber = "11.1"
...
function InquiryWallOrBase(Header)
  local dialog = HTML_Dialog(true, DialogWindow.myHtml7, 500, 490,  Header .. "  " .. Milling.UnitDisplay)
...
function OnLuaButton_InquiryLayers( )
  local dialog = HTML_Dialog(true, DialogWindow.myHtml4, 653, 439, "Layer Setup")
...
function OnLuaButton_InquiryMilling()
  local dialog = HTML_Dialog(true, DialogWindow.myHtml3 , 560, 227, "Milling Setting ")
...
function main(script_path)
  ...
  Tooler1 = assert(loadfile(script_path .. "\\EasyCabinetToolVer11.1.xlua")) (Tooler1) -- Load Tool Function
  Tooler2 = assert(loadfile(script_path .. "\\EasyCabinetWallVer11.1.xlua")) (Tooler2) -- Load Tool Function
  Tooler3 = assert(loadfile(script_path .. "\\EasyCabinetBaseVer11.1.xlua")) (Tooler3) -- Load Tool Function
  GetUnits()
  GetMaterialSettings()
  RegistryRead()
  HTML()
  ...
  if Drawing then
    ...
    if Project.Drawingx == "Wall" then
      ...
      DebugMarkPoint("WCab.Wpt1", Cab.Wpt1, 3, "Debug")
      DebugMarkPoint("WCab.Wpt2", Cab.Wpt2, 3, "Debug")
      DebugMarkPoint("WCab.Wpt3", Cab.Wpt3, 3, "Debug")
      DebugMarkPoint("WCab.Wpt4", Cab.Wpt4, 3, "Debug")
      DebugMarkPoint("WCab.Wpt5", Cab.Wpt5, 3, "Debug")
      DebugMarkPoint("WCab.Wpt6", Cab.Wpt6, 3, "Debug")
      DebugMarkPoint("WCab.Wpt7", Cab.Wpt7, 3, "Debug")
      DebugMarkPoint("WCab.Wpt8", Cab.Wpt8, 3, "Debug")
      ...
      if (WallQuestion.ShelfCount > 0) and WallQuestion.DrawShelfPanel then
    ...
    if Project.Drawingx == "Base" then
      ...
      DebugMarkPoint("BCab.Wpt1", Cab.Wpt1, 3, "Debug")
      DebugMarkPoint("BCab.Wpt2", Cab.Wpt2, 3, "Debug")
      DebugMarkPoint("BCab.Wpt3", Cab.Wpt3, 3, "Debug")
      DebugMarkPoint("BCab.Wpt4", Cab.Wpt4, 3, "Debug")
      DebugMarkPoint("BCab.Wpt5", Cab.Wpt5, 3, "Debug")
      DebugMarkPoint("BCab.Wpt6", Cab.Wpt6, 3, "Debug")
      DebugMarkPoint("BCab.Wpt7", Cab.Wpt7, 3, "Debug")
      DebugMarkPoint("BCab.Wpt8", Cab.Wpt8, 3, "Debug")
      DebugMarkPoint("BCab.Wpt9", Cab.Wpt9, 3, "Debug")
  end -- if end
