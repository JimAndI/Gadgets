...
-- Version 10-9.0 - Mar 13, 2020 - Added sheet layout H or V
-- ====================================================]]
-- Global variables
...
function GetMaterialSettings()
  ...
  --local units
    ...
    Material.Orantation = "H"
	else
    Material.Orantation = "V"
	end
  ...
  if  xy_origin == MaterialBlock.BLC then
    ...
    if Material.Orantation == "V" then
      ...
      Cab.Wpt1     = Point2D(mtl_block.Width - 1, 1)   --  Left Side Panel
      Cab.Wpt2     = Point2D(mtl_block.Width - 20, 1)  --  Right Side Panel
      Cab.Wpt3     = Point2D(mtl_block.Width - 40, 1)  --  Base_CabinetShelf
      Cab.Wpt4     = Point2D(mtl_block.Width - 14, 1)  --  Base_CenterPanel
      Cab.Wpt5     = Point2D(mtl_block.Width - 14, 34) --  Wall_CabinetShelf
      Cab.Wpt6     = Point2D(mtl_block.Width - 30, 1)  --  Base_CabinetBottom
      Cab.Wpt7     = Point2D(mtl_block.Width - 30, 1)  --  Wall_CenterPanel
      Cab.Wpt8     = Point2D(mtl_block.Width - 45, 1)  --  No Call = Polar2D(Cab.Wpt5, 0.0, WallDim.CabLength + Milling.PartGap) --  Shelf
  ...
  elseif xy_origin == MaterialBlock.BRC then
    ...
    if Material.Orantation == "V" then
      ...
      Cab.Wpt1     = Point2D(-1, mtl_block.Height - 1)   --  Left Side Panel
      Cab.Wpt2     = Point2D(-20, mtl_block.Height - 1)  --  Right Side Panel
      Cab.Wpt3     = Point2D(-40, mtl_block.Height - 1)  --  Base_CabinetShelf
      Cab.Wpt4     = Point2D(-14, mtl_block.Height - 1)  --  Base_CenterPanel
      Cab.Wpt5     = Point2D(-14, mtl_block.Height - 34) --  Wall_CabinetShelf
      Cab.Wpt6     = Point2D(-30, mtl_block.Height - 1)  --  Base_CabinetBottom
      Cab.Wpt7     = Point2D(-30, mtl_block.Height - 1)  --  Wall_CenterPanel
      Cab.Wpt8     = Point2D(-45, 1)  --  No Call = Polar2D(Cab.Wpt5, 0.0, WallDim.CabLength + Milling.PartGap) --  Shelf
      Cab.Wpt9     = Cab.Wpt1        --  Stretcher Parts
      Cab.Wpt10    = Cab.Wpt1        --  Stretcher Parts
    end
  elseif xy_origin == MaterialBlock.TRC then
    ...
    if Material.Orantation == "V" then
      Material.Direction = 270.0
      Cab.Wpt1     = Point2D(1 - mtl_block.Width, -1)   --  Left Side Panel
      Cab.Wpt2     = Point2D(20 - mtl_block.Width, -1)  --  Right Side Panel
      Cab.Wpt3     = Point2D(40 - mtl_block.Width, -1)  --  Base_CabinetShelf
      Cab.Wpt4     = Point2D(14 - mtl_block.Width, -1)  --  Base_CenterPanel
      Cab.Wpt5     = Point2D(14 - mtl_block.Width, -34) --  Wall_CabinetShelf
      Cab.Wpt6     = Point2D(30 - mtl_block.Width, -1)  --  Base_CabinetBottom
      Cab.Wpt7     = Point2D(30 - mtl_block.Width, -1)  --  Wall_CenterPanel
      Cab.Wpt8     = Point2D(45 - mtl_block.Width, -1)  --  No Call = Polar2D(Cab.Wpt5, 0.0, WallDim.CabLength + Milling.PartGap) --  Shelf
      Cab.Wpt9     = Cab.Wpt1        --  Stretcher Parts
      Cab.Wpt10    = Cab.Wpt1        --  Stretcher Parts
    else
      Material.Direction = 180.0
  ...
  elseif xy_origin == MaterialBlock.TLC then
    ...
    if Material.Orantation == "V" then
      ...
      Material.Direction = 0.0
      Cab.Wpt1     = Point2D(1, 1 - mtl_block.Height)   --  Left Side Panel
      Cab.Wpt2     = Point2D(20, 1 - mtl_block.Height)  --  Right Side Panel
      Cab.Wpt3     = Point2D(40, 1 - mtl_block.Height)  --  Base_CabinetShelf
      Cab.Wpt4     = Point2D(14, 1 - mtl_block.Height)  --  Base_CenterPanel
      Cab.Wpt5     = Point2D(14, 34 - mtl_block.Height) --  Wall_CabinetShelf
      Cab.Wpt6     = Point2D(30, 1 - mtl_block.Height)  --  Base_CabinetBottom
      Cab.Wpt7     = Point2D(30, 1 - mtl_block.Height)  --  Wall_CenterPanel
      Cab.Wpt8     = Point2D(45, 1 - mtl_block.Height)  --  No Call = Polar2D(Cab.Wpt5, 0.0, WallDim.CabLength + Milling.PartGap) --  Shelf
      Cab.Wpt9     = Cab.Wpt1        --  Stretcher Parts
      Cab.Wpt10    = Cab.Wpt1        --  Stretcher Parts
    end
  elseif xy_origin == MaterialBlock.CENTRE then  -- NOTE: English spelling for Centre!
    Material.XYorigin = "Center"
    MessageBox("Alert! Center XY Datum Position should not be used. Use corner of the Material")
      Material.Direction = 0.0
      Cab.Wpt1     = Point2D(0, 0)   --  Left Side Panel
      Cab.Wpt2     = Cab.Wpt1        --  Right Side Panel
      Cab.Wpt3     = Cab.Wpt1        --  Base_CabinetShelf
      Cab.Wpt4     = Cab.Wpt1        --  Base_CenterPanel
      Cab.Wpt5     = Cab.Wpt1        --  Wall_CabinetShelf
      Cab.Wpt6     = Cab.Wpt1        --  Base_CabinetBottom
      Cab.Wpt7     = Cab.Wpt1        --  Wall_CenterPanel
      Cab.Wpt8     = Cab.Wpt1        --  No Call = Polar2D(Cab.Wpt5, 0.0, WallDim.CabLength + Milling.PartGap) --  Shelf
      Cab.Wpt9     = Cab.Wpt1        --  Stretcher Parts
      Cab.Wpt10    = Cab.Wpt1        --  Stretcher Parts
  else
    Material.XYorigin = "Unknown XY origin value!"
    MessageBox("Error! -" .. Material.XYorigin .. "- XY Datum Position must be set at a corner of the Material")
    if Material.Orantation == "V" then
      Material.Direction = 0.0
      Cab.Wpt1     = Point2D(0, 0)   --  Left Side Panel
      Cab.Wpt2     = Cab.Wpt1        --  Right Side Panel
...
function REG_ReadRegistry()  --  Read from Registry values
  ...
  DialogWindow.InquiryWallOrBaseXY          = RegistryRead:GetString("DialogWindow.InquiryWallOrBaseXY", "0")
  ...
  Milling.Tool1                             = RegistryRead:GetString("Milling.Tool1",                      "No Tool Selected")
  Milling.Tool2                             = RegistryRead:GetString("Milling.Tool2",                      "No Tool Selected")
  Milling.Tool3                             = RegistryRead:GetString("Milling.Tool3",                      "No Tool Selected")
  Milling.Tool4                             = RegistryRead:GetString("Milling.Tool4",                      "No Tool Selected")
...
RegValue = RW:SetString("Milling.Tool1",                            Milling.Tool1)
RegValue = RW:SetString("Milling.Tool2",                            Milling.Tool2)
RegValue = RW:SetString("Milling.Tool3",                            Milling.Tool3)
RegValue = RW:SetString("Milling.Tool4",                            Milling.Tool4)
...
--  local TextHight = 0.5
--  local TextLayer = "JimAndi Gadgets"
--  local TextAng = 20.0
...
-- =========================================================]] -- Name
DialogWindow.myHtml5 = [[<html><head><title>Base Cabinet Setup</title> ]] .. DialogWindow.Style ..[[</head><body text="#000000"><table width="500" border="0" cellpadding="0" id="ValueTable"><tr><td width="180" align="right" valign="middle" nowrap class="h1-r"> Face Frame Rail Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameBottomRailWidth" type="text" class="h2" id="BaseDim.FaceFrameBottomRailWidth" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Bottom Reveal</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameBottomReveal" type="text" class="h2" id="BaseDim.FaceFrameBottomReveal" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Center Stile Face Frame Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameCenterStileWidth" type="text" class="h2" id="BaseDim.FaceFrameCenterStileWidth" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Side Reveal</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameSideReveal" type="text" class="h2" id="BaseDim.FaceFrameSideReveal" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Stile Face Frame Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameStileWidth" type="text" class="h2" id="BaseDim.FaceFrameStileWidth" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Drawer Height1</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameDrawerHeight1" type="text" class="h2" id="BaseDim.FaceFrameDrawerHeight1" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Top Rail Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameTopRailWidth" type="text" class="h2" id="BaseDim.FaceFrameTopRailWidth" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Drawer Height2</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameDrawerHeight2" type="text" class="h2" id="BaseDim.FaceFrameDrawerHeight2" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Material Thickness Back</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ThicknessBack" type="text" class="h2" id="BaseDim.ThicknessBack" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Drawer Height3</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameDrawerHeight3" type="text" class="h2" id="BaseDim.FaceFrameDrawerHeight3" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Mid Rail Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameMidRailWidth" type="text" class="h2" id="BaseDim.FaceFrameMidRailWidth" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Face Frame Thickness</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.FaceFrameThickness" type="text" class="h2" id="BaseDim.FaceFrameThickness" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Nosing Thickness</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfFaceFrameThickness" type="text" class="h2" id="BaseDim.ShelfFaceFrameThickness" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Cabinet Material Thickness</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.MaterialThickness" type="text" class="h2" id="BaseDim.MaterialThickness2" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf End Clarence</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfEndClarence" type="text" class="h2" id="BaseDim.ShelfEndClarence" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Clearance Front</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfFrontClearance" type="text" class="h2" id="BaseDim.ShelfFrontClearance" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Hole First Row Spacing</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfHoleFirstRowSpacing" type="text" class="h2" id="BaseDim.ShelfHoleFirstRowSpacing" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Material Thickness</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfMaterialThickness" type="text" class="h2" id="BaseDim.ShelfMaterialThickness" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Pin Hole Front</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfPinHoleFront" type="text" class="h2" id="BaseDim.ShelfPinHoleFront" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Nosing Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfFaceFrameWidth" type="text" class="h2" id="BaseDim.ShelfFaceFrameWidth" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Hole Spacing</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfHoleSpacing" type="text" class="h2" id="BaseDim.ShelfHoleSpacing" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Pin Hole Back</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfPinHoleBack" type="text" class="h2" id="BaseDim.ShelfPinHoleBack" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Hole Last Row Spacing</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ShelfHoleLastRowSpacing" type="text" class="h2" id="BaseDim.ShelfHoleLastRowSpacing" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Stretcher Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.StretcherWidth" type="text" class="h2" id="BaseDim.StretcherWidth" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Toe Kick Bottom Offset Height</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ToeKickBottomOffsetHeight" type="text" class="h2" id="BaseDim.ToeKickBottomOffsetHeight" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Stretcher Thickness</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.StretcherThickness" type="text" class="h2" id="BaseDim.StretcherThickness" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Toe Kick Depth</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ToeKickDepth" type="text" class="h2" id="BaseDim.ToeKickDepth" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Toe Kick Height</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.ToeKickHeight" type="text" class="h2" id="BaseDim.ToeKickHeight" size="10" maxlength="10" /></td></tr><tr><td width="180" align="right" valign="middle" nowrap class="h1-r">Top Frame Width</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><input name="BaseDim.TopFrameWidth" type="text" class="h2" id="BaseDim.TopFrameWidth" size="10" maxlength="10" /></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Add Center Panel</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><select name="BaseQuestion.AddCenterPanel" id="BaseQuestion.AddCenterPanel"><option selected>Yes</option><option>No</option></select></td></tr><tr><td width="180" height="22" align="right" valign="middle" nowrap class="h1-r">Drawer Row Count</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><select name="BaseQuestion.DrawerRowCount" id="BaseQuestion.DrawerRowCount"><option>0</option><option selected>1</option><option>2</option><option>3</option></select></td><td width="180" align="right" valign="middle" nowrap class="h1-r">Shelf Count</td><td width="70" align="right" valign="middle" nowrap class="h1-l"><select name="BaseQuestion.ShelfCount" id="BaseQuestion.ShelfCount"><option selected>0</option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option></select></td></tr></table><table width="100%" border="0" id="ButtonTable"><tr><td height="12" colspan="4" align="right" valign="middle" nowrap class="h2"><hr></td></tr><tr><td width="75"><button class="FormButton" onClick="window.open(']].. DialogWindow.BaseSDK .. [[');"><span class="icon">Help</span></button></td><td width="308" class="alert" id="GadgetName.Alert">.</td><td width="94" class="h1-c" style="width: 15%"><input id="ButtonOK" class="FormButton" name="ButtonOK" type="button" value="OK"></td><td width="89" class="h1-c" style="width: 15%"><input id="ButtonCancel" class="FormButton" name="ButtonCancel" type="button" value="Cancel"></td></tr></table></body></html>]]
-- =========================================================]] -- Layer Names
  DialogWindow.myHtml4 =  [[<html><head><title>Layer Names</title>]] .. DialogWindow.Style ..[[</head><body text = "#000000"><table width="600"><tr><td width="275" align="right" valign="middle" nowrap class="h1-rp"><span class="h1-r">Back Panel Profile</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><input name="Milling.LNBackPocket" type="text" class="h1-l" id="Milling.LNBackPocket" size="30" maxlength="50"/></td><td width="126"align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><label for="Milling.LNBackPocketColor">Color</label><select name="Milling.LNBackPocketColor" id="Milling.LNBackPocketColor"><option>Black</option><option selected>Red</option><option>Blue</option><option>Yellow</option><option>Cyan</option><option>Magenta</option><option>Green</option></select></td></tr></table><table width="600"><tr><td width="275" align="right" valign="middle" nowrap class="h1-rp"><span class="h1-r">BackPanel Pocket (Dado)</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><input name="Milling.LNBackProfile" type="text" class="h1-l" id="Milling.LNBackProfile" size="30" maxlength="50"/></td><td width="126"align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><label for="Milling.LNBackProfileColor">Color</label><select name="Milling.LNBackProfileColor" id="Milling.LNBackProfileColor"><option selected="selected">Black</option><option>Red</option><option>Blue</option><option>Yellow</option> <option>Cyan</option><option>Magenta</option><option>Green</option></select></td></tr></table><table width="600"><tr><td width="275" align="right" valign="middle" nowrap class="h1-rp"><span class="h1-r">Center Panel Profile</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><input name="Milling.LNCenterPanelProfile" type="text" class="h1-l" id="Milling.LNCenterPanelProfile" size="30" maxlength="50"/></td><td width="126"align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><label for="Milling.LNBackPocketColor">Color</label><select name="Milling.LNCenterPanelProfileColor" id="Milling.LNCenterPanelProfileColor"><option>Black</option><option>Red</option> <option>Blue</option><option>Yellow</option><option selected>Cyan</option><option>Magenta</option><option>Green</option> </select></td></tr></table><table width="600"><tr><td width="275" align="right" valign="middle" nowrap class="h1-rp"><span class="h1-r">Center Panel Shelf Pin Drilling</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><input name="Milling.LNCenterPanelShelfPinDrill" type="text" class="h1-l" id="Milling.LNCenterPanelShelfPinDrill" size="30" maxlength="50"/></td><td width="126"align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><label for="Milling.LNCenterPanelShelfPinDrillColor">Color</label><select name="Milling.LNCenterPanelShelfPinDrillColor" id="Milling.LNCenterPanelShelfPinDrillColor"><option selected="selected">Black</option> <option>Red</option><option>Blue</option> <option>Yellow</option><option>Cyan</option> <option>Magenta</option><option>Green</option></select></td></tr></table><table width="600"><tr><td width="275" align="right" valign="middle" nowrap class="h1-rp"><span class="h1-r">Face Fram Drawing</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><input name="Milling.LNDrawFaceFrame" type="text" class="h1-l" id="Milling.LNDrawFaceFrame" size="30" maxlength="50"/></td><td width="126"align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><label for="Milling.LNBackPocketColor">Color</label><select name="Milling.LNDrawFaceFrameColor" id="Milling.LNDrawFaceFrameColor"><option selected="selected">Black</option><option>Red</option><option>Blue</option> <option>Yellow</option><option>Cyan</option><option>Magenta</option> <option>Green</option></select></td></tr></table><table width="600"><tr><td width="275" align="right" valign="middle" nowrap class="h1-rp"><span class="h1-r">Cabinet Side Pocket (Dado and Rabbet)</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><input name="Milling.LNSidePocket" type="text" class="h1-l" id="Milling.LNSidePocket" size="30" maxlength="50"/></td><td width="126"align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><label for="Milling.LNBackPocketColor">Color</label><select name="Milling.LNSidePocketColor" id="Milling.LNSidePocketColor"><option>Black</option> <option>Red</option><option>Blue</option><option>Yellow</option> <option selected>Cyan</option><option>Magenta</option><option>Green</option></select></td></tr></table><table width="600"><tr><td width="275" align="right" valign="middle" nowrap class="h1-rp"><span class="h1-r">Cabinet Side - Shelf Pin Drilling</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><input name"Milling.LNSideShelfPinDrill" type="text" class="h1-l" id="Milling.LNSideShelfPinDrill" size="30" maxlength="50"/></td><td width="126"align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><label for="Milling.LNSideShelfPinDrillColor">Color</label><select name="Milling.LNSideShelfPinDrillColor" id="Milling.LNSideShelfPinDrillColor"><option>Black</option><option selected>Red</option><option>Blue</option><option>Yellow</option><option>Cyan</option> <option>Magenta</option><option>Green</option></select></td></tr></table><table width="600"><tr><td width="275" align="right" valign="middle" nowrap class="h1-rp"><span class="h1-r">Top and Bottom Profile</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><input name="Milling.LNTopBottomProfile" type="text" class="h1-l" id="Milling.LNTopBottomProfile" size="30" maxlength="50"/></td><td width="126"align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><label for="Milling.LNTopBottomProfileColor">Color</label><select name="Milling.LNTopBottomProfileColor" id="Milling.LNTopBottomProfileColor"><option>Black</option><option>Red</option><option>Blue</option><option>Yellow</option><option>Cyan</option><option>Magenta</option><option selected>Green</option></select></td></tr></table><table width="600"><tr><td width="275" align="right" valign="middle" nowrap class="h1-rp"><span class="h1-r">Top and Bottom Pocket</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><input name="Milling.LNTopBottomPocket" type="text" class="h1-l" id="Milling.LNTopBottomPocket" size="30" maxlength="50"/></td><td width="126"align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><label for="Milling.LNBackPocketColor">Color</label><select name="Milling.LNTopBottomPocketColor" id="Milling.LNTopBottomPocketColor"><option>Black</option><option>Red</option><option selected>Blue</option><option>Yellow</option><option>Cyan</option><option>Magenta</option> <option>Green</option></select></td></tr></table><table width="600"><tr><td width="275" align="right" valign="middle" nowrap class="h1-rp"><span class="h1-r">Stretcher and Rail Profile</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><input name="Milling.LNStretcherRailProfile" type="text" class="h1-l" id="Milling.LNStretcherRailProfile" size="30" maxlength="50"/></td><td width="126"align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><label for="Milling.LNBackPocketColor">Color</label><select name="Milling.LNStretcherRailProfileColor" id="Milling.LNStretcherRailProfileColor"><option selected="selected">Black</option><option>Red</option><option>Blue</option><option>Yellow</option><option>Cyan</option><option>Magenta</option><option>Green</option></select></td></tr></table><table width="600"><tr><td width="275" align="right" valign="middle" nowrap class="h1-rp"><span class="h1-r">Draw Notes</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><input name="Milling.LNDrawNotes" type="text" class="h1-l" id="Milling.LNDrawNotes" size="30" maxlength="50"/></td><td width="126"align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><label for="Milling.LNDrawNotesColor">Color</label><select name="Milling.LNDrawNotesColor" id="Milling.LNDrawNotesColor"><option>Black</option><option>Red</option><option selected>Blue</option><option>Yellow</option><option>Cyan</option><option>Magenta</option><option>Green</option></select></td></tr></table><table width="600"><tr><td width="275" align="right" valign="middle" nowrap class="h1-rp"><span class="h1-r">Part Labels</span></td><td align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><input name="Milling.LNPartLabels" type="text" class="h1-l" id="Milling.LNPartLabels" size="30" maxlength="50"/></td><td width="126"align="right" valign="middle" nowrap class="h1-l" id="ValueTable"><label for="Milling.LNBackPocketColor">Color</label><select name="Milling.LNPartLabelsColor" id="Milling.LNPartLabelsColor"><option>Black</option><option>Red</option><option>Blue</option><option>Yellow</option><option>Cyan</option><option>Magenta</option><option selected>Green</option></select></td></tr></table><table width="100%" border="0" id="ButtonTable">
<tr><td height="12" colspan="4" align="right" valign="middle" nowrap class="h2"><hr></td></tr><tr><td width="75"><button class="FormButton" onClick="window.open(']].. DialogWindow.LayerSDK .. [[');"><span class="icon">Help</span></button></td><td width="308" class="alert" id="GadgetName.Alert">.</td><td width="94" class="h1-c" style="width: 15%"><input id="ButtonOK" class="FormButton" name="ButtonOK" type="button" value="OK"></td><td width="89" class="h1-c" style="width: 15%"><input id="ButtonCancel" class="FormButton" name="ButtonCancel" type="button" value="Cancel"></td></tr></table></body></html>]]
-- =========================================================]] -- Milling Information
